...
public final class ThreadContextKt {
    ...
    public static final Object updateThreadContext(CoroutineContext context, Object countOrElement) {
        Object threadContextElements = countOrElement == null ? threadContextElements(context) : countOrElement;
        return threadContextElements == 0 ? NO_THREAD_ELEMENTS : threadContextElements instanceof Integer ? context.fold(new ThreadState(context, ((Number) threadContextElements).intValue()), updateState) : ((ThreadContextElement) threadContextElements).updateThreadContext(context);
    }
}
