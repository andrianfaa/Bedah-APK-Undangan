...
public class LinkedListChannel<E> extends AbstractChannel<E> {
    ...
    public void m1552onCancelIdempotentListww6eGU(Object list, Closed<?> closed) {
        ...
        if (list != null) {
            ...
            if (!(list instanceof ArrayList)) {
                ...
                if (send instanceof AbstractSendChannel.SendBuffered) {
                    ...
                    if (function1 != null) {
                        undeliveredElementException2 = OnUndeliveredElementKt.callUndeliveredElementCatchingException(function1, ((AbstractSendChannel.SendBuffered) send).element, (UndeliveredElementException) null);
                    }
                ...
                if (size >= 0) {
                    do {
                        int i = size;
                        size--;
                        Send send2 = (Send) arrayList.get(i);
                        if (send2 instanceof AbstractSendChannel.SendBuffered) {
                            Function1 function12 = this.onUndeliveredElement;
                            undeliveredElementException = function12 == null ? null : OnUndeliveredElementKt.callUndeliveredElementCatchingException(function12, ((AbstractSendChannel.SendBuffered) send2).element, undeliveredElementException);
                            continue;
                        } else {
    ...
    public Object offerSelectInternal(E element, SelectInstance<?> select) {
        ...
        while (true) {
            if (getHasReceiveOrClosed()) {
                obj = super.offerSelectInternal(element, select);
            } else {
                obj = select.performAtomicTrySelect(describeSendBuffered(element));
                if (obj == null) {
            ...
            if (obj != AbstractChannelKt.OFFER_FAILED && obj != AtomicKt.RETRY_ATOMIC) {
                ...
                String stringPlus = Intrinsics.stringPlus("Invalid result ", obj);
                Log1F380D.a((Object) stringPlus);
                throw new IllegalStateException(stringPlus.toString());
            }
        }
