...
public final class ActorKt {
    public static final <E> SendChannel<E> actor(CoroutineScope $this$actor, CoroutineContext context, int capacity, CoroutineStart start, Function1<? super Throwable, Unit> onCompletion, Function2<? super ActorScope<E>, ? super Continuation<? super Unit>, ? extends Object> block) {
        CoroutineContext newCoroutineContext = CoroutineContextKt.newCoroutineContext($this$actor, context);
        Channel Channel$default = ChannelKt.Channel$default(capacity, (BufferOverflow) null, (Function1) null, 6, (Object) null);
        ActorCoroutine lazyActorCoroutine = start.isLazy() ? new LazyActorCoroutine(newCoroutineContext, Channel$default, block) : new ActorCoroutine(newCoroutineContext, Channel$default, true);
    ...
    public static /* synthetic */ SendChannel actor$default(CoroutineScope coroutineScope, CoroutineContext coroutineContext, int i, CoroutineStart coroutineStart, Function1 function1, Function2 function2, int i2, Object obj) {
        return actor(coroutineScope, (i2 & 1) != 0 ? EmptyCoroutineContext.INSTANCE : coroutineContext, (i2 & 2) != 0 ? 0 : i, (i2 & 4) != 0 ? CoroutineStart.DEFAULT : coroutineStart, (i2 & 8) != 0 ? null : function1, function2);
    }
}
