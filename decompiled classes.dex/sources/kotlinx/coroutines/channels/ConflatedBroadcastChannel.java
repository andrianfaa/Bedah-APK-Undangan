...
public final class ConflatedBroadcastChannel<E> implements BroadcastChannel<E> {
        ...
        do {
            ...
            if (!(obj instanceof Closed)) {
                if (obj instanceof State) {
                    ...
                    String stringPlus = Intrinsics.stringPlus("Invalid state ", obj);
    ...
    private final Subscriber<E>[] removeSubscriber(Subscriber<E>[] list, Subscriber<E> subscriber) {
        ...
        int indexOf = ArraysKt.indexOf((T[]) list, subscriber);
        ...
        ArraysKt.copyInto$default((Object[]) subscriberArr2, (Object[]) subscriberArr3, 0, 0, indexOf, 6, (Object) null);
        ArraysKt.copyInto$default((Object[]) subscriberArr2, (Object[]) subscriberArr3, indexOf, indexOf + 1, 0, 8, (Object) null);
        return subscriberArr;
    }
    ...
    public Object m1550trySendJP2dKIU(E element) {
        Closed offerInternal = offerInternal(element);
        return offerInternal == null ? ChannelResult.Companion.m1549successJP2dKIU(Unit.INSTANCE) : ChannelResult.Companion.m1547closedJP2dKIU(offerInternal.getSendException());
    }
    ...
    private final kotlinx.coroutines.channels.ConflatedBroadcastChannel.Closed offerInternal(E r14) {
        ...
        L_0x000c:
            ...
            r3 = 0
        L_0x000f:
            java.lang.Object r4 = r0._state     // Catch:{ all -> 0x0064 }
            r5 = 0
            boolean r6 = r4 instanceof kotlinx.coroutines.channels.ConflatedBroadcastChannel.Closed     // Catch:{ all -> 0x0064 }
            if (r6 == 0) goto L_0x001e
            r2 = r4
            kotlinx.coroutines.channels.ConflatedBroadcastChannel$Closed r2 = (kotlinx.coroutines.channels.ConflatedBroadcastChannel.Closed) r2     // Catch:{ all -> 0x0064 }
        L_0x001b:
            r13._updating = r1
            return r2
        L_0x001e:
            boolean r6 = r4 instanceof kotlinx.coroutines.channels.ConflatedBroadcastChannel.State     // Catch:{ all -> 0x0064 }
            if (r6 == 0) goto L_0x0051
            kotlinx.coroutines.channels.ConflatedBroadcastChannel$State r6 = new kotlinx.coroutines.channels.ConflatedBroadcastChannel$State     // Catch:{ all -> 0x0064 }
            r7 = r4
            kotlinx.coroutines.channels.ConflatedBroadcastChannel$State r7 = (kotlinx.coroutines.channels.ConflatedBroadcastChannel.State) r7     // Catch:{ all -> 0x0064 }
            kotlinx.coroutines.channels.ConflatedBroadcastChannel$Subscriber<E>[] r7 = r7.subscribers     // Catch:{ all -> 0x0064 }
            r6.<init>(r14, r7)     // Catch:{ all -> 0x0064 }
            java.util.concurrent.atomic.AtomicReferenceFieldUpdater r7 = _state$FU     // Catch:{ all -> 0x0064 }
            boolean r7 = androidx.concurrent.futures.AbstractResolvableFuture$SafeAtomicHelper$$ExternalSyntheticBackportWithForwarding0.m(r7, r13, r4, r6)     // Catch:{ all -> 0x0064 }
            if (r7 == 0) goto L_0x004e
            r0 = r4
            kotlinx.coroutines.channels.ConflatedBroadcastChannel$State r0 = (kotlinx.coroutines.channels.ConflatedBroadcastChannel.State) r0     // Catch:{ all -> 0x0064 }
            kotlinx.coroutines.channels.ConflatedBroadcastChannel$Subscriber<E>[] r0 = r0.subscribers     // Catch:{ all -> 0x0064 }
            if (r0 != 0) goto L_0x003c
            goto L_0x004c
        L_0x003c:
            r7 = 0
            int r8 = r0.length     // Catch:{ all -> 0x0064 }
            r9 = r1
        L_0x003f:
            if (r9 >= r8) goto L_0x004b
            r10 = r0[r9]     // Catch:{ all -> 0x0064 }
            int r9 = r9 + 1
            r11 = r10
            r12 = 0
            r11.offerInternal(r14)     // Catch:{ all -> 0x0064 }
            goto L_0x003f
        L_0x004b:
        L_0x004c:
            goto L_0x001b
        ...
        L_0x0051:
            ...
            java.lang.String r2 = kotlin.jvm.internal.Intrinsics.stringPlus(r2, r4)     // Catch:{ all -> 0x0064 }
    ...
    public final E getValue() {
        ...
        if (obj instanceof Closed) {
            ...
            Log1F380D.a((Object) stringPlus);
            throw new IllegalStateException(stringPlus.toString());
        } else if (((State) obj).value != UNDEFINED) {
    ...
    public ReceiveChannel<E> openSubscription() {
        ...
        } while (!AbstractResolvableFuture$SafeAtomicHelper$$ExternalSyntheticBackportWithForwarding0.m(_state$FU, this, obj, new State(((State) obj).value, addSubscriber(((State) obj).subscribers, subscriber))));
        return subscriber;
    }
}
