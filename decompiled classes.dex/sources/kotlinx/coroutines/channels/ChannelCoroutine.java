...
public class ChannelCoroutine<E> extends AbstractCoroutine<Unit> implements Channel<E> {
    ...
    public /* synthetic */ void cancel() {
        ...
        cancelInternal(new JobCancellationException(access$cancellationExceptionMessage, (Throwable) null, this));
    }

    public void cancelInternal(Throwable cause) {
        CancellationException cancellationException$default = JobSupport.toCancellationException$default(this, cause, (String) null, 1, (Object) null);
    ...
    public Object m1527receiveCatchingJP2dKIU(Continuation<? super ChannelResult<? extends E>> continuation) {
        Object r0 = this._channel.m1553receiveCatchingJP2dKIU(continuation);
    ...
    public Object m1528tryReceivePtdJZtk() {
        return this._channel.m1554tryReceivePtdJZtk();
    }

    /* renamed from: trySend-JP2dKIU  reason: not valid java name */
    public Object m1529trySendJP2dKIU(E e) {
        return this._channel.m1556trySendJP2dKIU(e);
    }
