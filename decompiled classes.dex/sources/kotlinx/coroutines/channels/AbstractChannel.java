...
public abstract class AbstractChannel<E> extends AbstractSendChannel<E> implements Channel<E> {
    ...
    private static final class Itr<E> implements ChannelIterator<E> {
        ...
        public final Object hasNextSuspend(Continuation<? super Boolean> $completion) {
            ...
            while (true) {
                if (this.channel.enqueueReceive(receiveHasNext)) {
                    this.channel.removeReceiveOnCancel(cancellableContinuation, receiveHasNext);
                    break;
                }
                ...
                if (pollInternal instanceof Closed) {
                    if (((Closed) pollInternal).closeCause == null) {
                        ...
                        cancellableContinuation.resumeWith(Result.m36constructorimpl(Boxing.boxBoolean(false)));
                    } else {
                        Result.Companion companion2 = Result.Companion;
                        cancellableContinuation.resumeWith(Result.m36constructorimpl(ResultKt.createFailure(((Closed) pollInternal).getReceiveException())));
                    }
        ...
        public Object hasNext(Continuation<? super Boolean> $completion) {
            ...
            return getResult() != AbstractChannelKt.POLL_FAILED ? Boxing.boxBoolean(hasNextResult(getResult())) : hasNextSuspend($completion);
        }
    ...
    private static class ReceiveElement<E> extends Receive<E> {
        ...
        public void resumeReceiveClosed(Closed<?> closed) {
            if (this.receiveMode == 1) {
                Result.Companion companion = Result.Companion;
                this.cont.resumeWith(Result.m36constructorimpl(ChannelResult.m1534boximpl(ChannelResult.Companion.m1547closedJP2dKIU(closed.closeCause))));
                return;
            }
            Result.Companion companion2 = Result.Companion;
            this.cont.resumeWith(Result.m36constructorimpl(ResultKt.createFailure(closed.getReceiveException())));
        }

        public final Object resumeValue(E value) {
            return this.receiveMode == 1 ? ChannelResult.m1534boximpl(ChannelResult.Companion.m1549successJP2dKIU(value)) : value;
        }

        public String toString() {
            StringBuilder append = new StringBuilder().append("ReceiveElement@");
            String hexAddress = DebugStringsKt.getHexAddress(this);
            Log1F380D.a((Object) hexAddress);
            return append.append(hexAddress).append("[receiveMode=").append(this.receiveMode).append(']').toString();
        }
    ...
    private static class ReceiveHasNext<E> extends Receive<E> {
        ...
        public void resumeReceiveClosed(Closed<?> closed) {
            Object tryResume$default = closed.closeCause == null ? CancellableContinuation.DefaultImpls.tryResume$default(this.cont, false, (Object) null, 2, (Object) null) : this.cont.tryResumeWithException(closed.getReceiveException());
        ...
        public String toString() {
            String hexAddress = DebugStringsKt.getHexAddress(this);
            Log1F380D.a((Object) hexAddress);
            String stringPlus = Intrinsics.stringPlus("ReceiveHasNext@", hexAddress);
    ...
    private static final class ReceiveSelect<R, E> extends Receive<E> implements DisposableHandle {
        ...
        public void completeResumeReceive(E value) {
            CancellableKt.startCoroutineCancellable(this.block, this.receiveMode == 1 ? ChannelResult.m1534boximpl(ChannelResult.Companion.m1549successJP2dKIU(value)) : value, this.select.getCompletion(), resumeOnCancellationFun(value));
        }
            ...
            if (this.select.trySelect()) {
                switch (this.receiveMode) {
                    case 0:
                        ...
                        return;
                    case 1:
                        CancellableKt.startCoroutineCancellable$default(this.block, ChannelResult.m1534boximpl(ChannelResult.Companion.m1547closedJP2dKIU(closed.closeCause)), this.select.getCompletion(), (Function1) null, 4, (Object) null);
                        return;
                    default:
                        return;
                }
        ...
        public String toString() {
            StringBuilder append = new StringBuilder().append("ReceiveSelect@");
            String hexAddress = DebugStringsKt.getHexAddress(this);
            Log1F380D.a((Object) hexAddress);
            return append.append(hexAddress).append('[').append(this.select).append(",receiveMode=").append(this.receiveMode).append(']').toString();
        }
    ...
    public final <R> Object receiveSuspend(int receiveMode, Continuation<? super R> $completion) {
        ...
        CancellableContinuation cancellableContinuation = orCreateCancellableContinuation;
        ReceiveElement receiveElement = this.onUndeliveredElement == null ? new ReceiveElement(cancellableContinuation, receiveMode) : new ReceiveElementWithUndeliveredHandler(cancellableContinuation, receiveMode, this.onUndeliveredElement);
        while (true) {
            if (!enqueueReceive(receiveElement)) {
                ...
                removeReceiveOnCancel(cancellableContinuation, receiveElement);
                break;
            }
        }
    ...
    private final <R> void tryStartBlockUnintercepted(Function2<Object, ? super Continuation<? super R>, ? extends Object> $this$tryStartBlockUnintercepted, SelectInstance<? super R> select, int receiveMode, Object value) {
        if (value instanceof Closed) {
            switch (receiveMode) {
                ...
                case 1:
                    if (select.trySelect()) {
                        UndispatchedKt.startCoroutineUnintercepted($this$tryStartBlockUnintercepted, ChannelResult.m1534boximpl(ChannelResult.Companion.m1547closedJP2dKIU(((Closed) value).closeCause)), select.getCompletion());
                        return;
                    }
                    return;
                default:
            ...
            Object obj = value;
            UndispatchedKt.startCoroutineUnintercepted($this$tryStartBlockUnintercepted, ChannelResult.m1534boximpl(obj instanceof Closed ? ChannelResult.Companion.m1547closedJP2dKIU(((Closed) obj).closeCause) : ChannelResult.Companion.m1549successJP2dKIU(obj)), select.getCompletion());
        } else {
    ...
    public final void cancel(CancellationException cause) {
        ...
        if (!isClosedForReceive()) {
            if (cause == null) {
                ...
                Log1F380D.a((Object) stringPlus);
                cancellationException = new CancellationException(stringPlus);
            } else {
    ...
    public void onCancelIdempotent(boolean wasClosed) {
        ...
        if (closedForSend != null) {
            Object r1 = InlineList.m1571constructorimpl$default((Object) null, 1, (DefaultConstructorMarker) null);
            while (true) {
                LockFreeLinkedListNode prevNode = closedForSend.getPrevNode();
                if (prevNode instanceof LockFreeLinkedListHead) {
                    m1522onCancelIdempotentListww6eGU(r1, closedForSend);
                    return;
                    ...
                    r1 = InlineList.m1576plusFjFbRPM(r1, (Send) prevNode);
                }
            }
        } else {
    ...
    public void m1522onCancelIdempotentListww6eGU(Object list, Closed<?> closed) {
        if (list != null) {
            if (!(list instanceof ArrayList)) {
                ...
                if (size >= 0) {
                    do {
                        int i = size;
                        size--;
                        ((Send) arrayList.get(i)).resumeSendClosed(closed);
                    } while (size >= 0);
                }
            } else {
    ...
    public final Object receive(Continuation<? super E> $completion) {
        Object pollInternal = pollInternal();
        return (pollInternal == AbstractChannelKt.POLL_FAILED || (pollInternal instanceof Closed)) ? receiveSuspend(0, $completion) : pollInternal;
    }
    ...
    /* Code decompiled incorrectly, please refer to instructions dump. */
    public final java.lang.Object m1523receiveCatchingJP2dKIU(kotlin.coroutines.Continuation<? super kotlinx.coroutines.channels.ChannelResult<? extends E>> r6) {
        /*
            r5 = this;
        ...
        L_0x0032:
            ...
            java.lang.Object r3 = r3.m1547closedJP2dKIU(r4)
            goto L_0x0056
        L_0x0050:
            kotlinx.coroutines.channels.ChannelResult$Companion r3 = kotlinx.coroutines.channels.ChannelResult.Companion
            java.lang.Object r3 = r3.m1549successJP2dKIU(r1)
        L_0x0056:
            return r3
        L_0x0057:
            r3 = 1
        ...
        L_0x0061:
            ...
            return r1
        */
        throw new UnsupportedOperationException("Method not decompiled: kotlinx.coroutines.channels.AbstractChannel.m1523receiveCatchingJP2dKIU(kotlin.coroutines.Continuation):java.lang.Object");
    }
    ...
    public ReceiveOrClosed<E> takeFirstReceiveOrPeekClosed() {
        ...
        ReceiveOrClosed<E> receiveOrClosed = takeFirstReceiveOrPeekClosed;
    ...
    public final Object m1524tryReceivePtdJZtk() {
        Object pollInternal = pollInternal();
        return pollInternal == AbstractChannelKt.POLL_FAILED ? ChannelResult.Companion.m1548failurePtdJZtk() : pollInternal instanceof Closed ? ChannelResult.Companion.m1547closedJP2dKIU(((Closed) pollInternal).closeCause) : ChannelResult.Companion.m1549successJP2dKIU(pollInternal);
    }
}
