...
public final class ChannelKt {
    public static final <E> Channel<E> Channel(int capacity, BufferOverflow onBufferOverflow, Function1<? super E, Unit> onUndeliveredElement) {
        ...
        switch (capacity) {
            ...
            case 0:
                return onBufferOverflow == BufferOverflow.SUSPEND ? new RendezvousChannel(onUndeliveredElement) : new ArrayChannel(1, onBufferOverflow, onUndeliveredElement);
            case Integer.MAX_VALUE:
                return new LinkedListChannel<>(onUndeliveredElement);
            default:
                return (capacity == 1 && onBufferOverflow == BufferOverflow.DROP_OLDEST) ? new ConflatedChannel(onUndeliveredElement) : new ArrayChannel(capacity, onBufferOverflow, onUndeliveredElement);
        }
    }
    ...
    public static final <T> T m1530getOrElseWpGqRn0(Object $this$getOrElse, Function1<? super Throwable, ? extends T> onFailure) {
        return $this$getOrElse instanceof ChannelResult.Failed ? onFailure.invoke(ChannelResult.m1538exceptionOrNullimpl($this$getOrElse)) : $this$getOrElse;
    }

    /* renamed from: onClosed-WpGqRn0  reason: not valid java name */
    public static final <T> Object m1531onClosedWpGqRn0(Object $this$onClosed, Function1<? super Throwable, Unit> action) {
        if ($this$onClosed instanceof ChannelResult.Closed) {
            action.invoke(ChannelResult.m1538exceptionOrNullimpl($this$onClosed));
        }
        return $this$onClosed;
    }

    /* renamed from: onFailure-WpGqRn0  reason: not valid java name */
    public static final <T> Object m1532onFailureWpGqRn0(Object $this$onFailure, Function1<? super Throwable, Unit> action) {
        if ($this$onFailure instanceof ChannelResult.Failed) {
            action.invoke(ChannelResult.m1538exceptionOrNullimpl($this$onFailure));
        }
        return $this$onFailure;
    }

    /* renamed from: onSuccess-WpGqRn0  reason: not valid java name */
    public static final <T> Object m1533onSuccessWpGqRn0(Object $this$onSuccess, Function1<? super T, Unit> action) {
