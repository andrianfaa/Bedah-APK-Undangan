...
public final class ChannelResult<T> {
    ...
    public static final class Companion {
        ...
        public final <E> Object m1547closedJP2dKIU(Throwable cause) {
            return ChannelResult.m1535constructorimpl(new Closed(cause));
        }

        /* renamed from: failure-PtdJZtk  reason: not valid java name */
        public final <E> Object m1548failurePtdJZtk() {
            return ChannelResult.m1535constructorimpl(ChannelResult.failed);
        }

        /* renamed from: success-JP2dKIU  reason: not valid java name */
        public final <E> Object m1549successJP2dKIU(E value) {
            return ChannelResult.m1535constructorimpl(value);
        }
    }
    ...
    public static final /* synthetic */ ChannelResult m1534boximpl(Object obj) {
        return new ChannelResult(obj);
    }

    /* renamed from: constructor-impl  reason: not valid java name */
    public static <T> Object m1535constructorimpl(Object obj) {
        return obj;
    }

    /* renamed from: equals-impl  reason: not valid java name */
    public static boolean m1536equalsimpl(Object obj, Object obj2) {
        return (obj2 instanceof ChannelResult) && Intrinsics.areEqual(obj, ((ChannelResult) obj2).m1546unboximpl());
    }

    /* renamed from: equals-impl0  reason: not valid java name */
    public static final boolean m1537equalsimpl0(Object obj, Object obj2) {
        return Intrinsics.areEqual(obj, obj2);
    }

    /* renamed from: exceptionOrNull-impl  reason: not valid java name */
    public static final Throwable m1538exceptionOrNullimpl(Object arg0) {
    ...
    public static final T m1539getOrNullimpl(Object arg0) {
    ...
    public static final T m1540getOrThrowimpl(Object arg0) {
        if (!(arg0 instanceof Failed)) {
            return arg0;
        }
        if (!(arg0 instanceof Closed) || ((Closed) arg0).cause == null) {
            String stringPlus = Intrinsics.stringPlus("Trying to call 'getOrThrow' on a failed channel result: ", arg0);
    ...
    public static int m1541hashCodeimpl(Object obj) {
        if (obj == null) {
            return 0;
        }
        return obj.hashCode();
    ...
    public static final boolean m1542isClosedimpl(Object arg0) {
        return arg0 instanceof Closed;
    }

    /* renamed from: isFailure-impl  reason: not valid java name */
    public static final boolean m1543isFailureimpl(Object arg0) {
        return arg0 instanceof Failed;
    }

    /* renamed from: isSuccess-impl  reason: not valid java name */
    public static final boolean m1544isSuccessimpl(Object arg0) {
        return !(arg0 instanceof Failed);
    }

    /* renamed from: toString-impl  reason: not valid java name */
    public static String m1545toStringimpl(Object arg0) {
        return arg0 instanceof Closed ? ((Closed) arg0).toString() : "Value(" + arg0 + ')';
    }

    public boolean equals(Object obj) {
        return m1536equalsimpl(this.holder, obj);
    }

    public int hashCode() {
        return m1541hashCodeimpl(this.holder);
    }

    /* renamed from: unbox-impl  reason: not valid java name */
    public final /* synthetic */ Object m1546unboximpl() {
        return this.holder;
    }

    public String toString() {
        String r0 = m1545toStringimpl(this.holder);
