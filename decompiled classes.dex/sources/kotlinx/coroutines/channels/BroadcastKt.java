...
public final class BroadcastKt {
    public static final <E> BroadcastChannel<E> broadcast(CoroutineScope $this$broadcast, CoroutineContext context, int capacity, CoroutineStart start, Function1<? super Throwable, Unit> onCompletion, Function2<? super ProducerScope<? super E>, ? super Continuation<? super Unit>, ? extends Object> block) {
        CoroutineContext newCoroutineContext = CoroutineContextKt.newCoroutineContext($this$broadcast, context);
        BroadcastChannel BroadcastChannel = BroadcastChannelKt.BroadcastChannel(capacity);
        BroadcastCoroutine lazyBroadcastCoroutine = start.isLazy() ? new LazyBroadcastCoroutine(newCoroutineContext, BroadcastChannel, block) : new BroadcastCoroutine(newCoroutineContext, BroadcastChannel, true);
