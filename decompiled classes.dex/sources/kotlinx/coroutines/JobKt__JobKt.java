...
final /* synthetic */ class JobKt__JobKt {
    ...
    public static final /* synthetic */ void cancelChildren(Job $this$cancelChildren, Throwable cause) {
        for (Job next : $this$cancelChildren.getChildren()) {
            JobSupport jobSupport = next instanceof JobSupport ? (JobSupport) next : null;
            if (jobSupport != null) {
    ...
    public static final void cancelChildren(Job $this$cancelChildren, CancellationException cause) {
        for (Job cancel : $this$cancelChildren.getChildren()) {
            cancel.cancel(cause);
        }
    }
    ...
    public static final Job getJob(CoroutineContext $this$job) {
        ...
        String stringPlus = Intrinsics.stringPlus("Current context doesn't contain Job in it: ", $this$job);
