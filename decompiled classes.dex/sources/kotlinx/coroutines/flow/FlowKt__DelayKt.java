...
final /* synthetic */ class FlowKt__DelayKt {
    public static final <T> Flow<T> debounce(Flow<? extends T> $this$debounce, long timeoutMillis) {
        if (timeoutMillis >= 0) {
            return timeoutMillis == 0 ? $this$debounce : debounceInternal$FlowKt__DelayKt($this$debounce, new FlowKt__DelayKt$debounce$2(timeoutMillis));
        }
    ...
    public static final <T> Flow<T> m1561debounceHG0u8IE(Flow<? extends T> $this$debounce, long timeout) {
        return FlowKt.debounce($this$debounce, DelayKt.m1514toDelayMillisLRDsOJo(timeout));
    }
    ...
    public static final <T> Flow<T> m1562sampleHG0u8IE(Flow<? extends T> $this$sample, long period) {
        return FlowKt.sample($this$sample, DelayKt.m1514toDelayMillisLRDsOJo(period));
    }
}
