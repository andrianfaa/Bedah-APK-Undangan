...
public final class FlowKt__TransformKt$filterNot$$inlined$unsafeTransform$1 implements Flow<T> {
    ...
    public Object collect(FlowCollector collector, Continuation $completion) {
        final FlowCollector flowCollector = collector;
        ...
        Object collect = flow.collect(new Object() {
            ...
            public final Object emit$$forInline(Object value, Continuation $completion) {
                ...
                InlineMarker.mark(5);
                FlowCollector flowCollector = r0;
                Object obj = value;
                Continuation continuation = $completion;
                if (!((Boolean) r5.invoke(obj, $completion)).booleanValue()) {
                    InlineMarker.mark(0);
                    flowCollector.emit(obj, $completion);
                    InlineMarker.mark(1);
                }
    ...
    public Object collect$$forInline(FlowCollector collector, Continuation $completion) {
        ...
        flow.collect(new Object() {
            ...
            public final Object emit$$forInline(Object value, Continuation $completion) {
                ...
                Object obj = value;
                Continuation continuation = $completion;
                if (!((Boolean) function2.invoke(obj, $completion)).booleanValue()) {
                    InlineMarker.mark(0);
                    flowCollector.emit(obj, $completion);
                    InlineMarker.mark(1);
                }
