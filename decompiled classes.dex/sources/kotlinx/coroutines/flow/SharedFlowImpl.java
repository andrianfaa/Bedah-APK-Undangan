...
public class SharedFlowImpl<T> extends AbstractSharedFlow<SharedFlowSlot> implements MutableSharedFlow<T>, CancellableFlow<T>, FusibleFlow<T> {
    ...
    public final Object awaitValue(SharedFlowSlot slot, Continuation<? super Unit> $completion) {
        ...
        synchronized (this) {
            if (tryPeekLocked(slot) < 0) {
                slot.cont = cancellableContinuation;
                slot.cont = cancellableContinuation;
            } else {
        ...
        if (!(abstractSharedFlow.nCollectors == 0 || (access$getSlots = abstractSharedFlow.slots) == null)) {
            ...
            while (i < length) {
                ...
                if (abstractSharedFlowSlot2 != null) {
                    SharedFlowSlot sharedFlowSlot = (SharedFlowSlot) abstractSharedFlowSlot2;
    ...
    public final Object emitSuspend(T value, Continuation<? super Unit> $completion) {
        ...
        synchronized (this) {
            if (tryEmitLocked(value)) {
                ...
                Emitter emitter2 = new Emitter(this, ((long) getTotalSize()) + getHead(), value, cancellableContinuation);
        ...
        if (emitter3 != null) {
            CancellableContinuationKt.disposeOnCancellation(cancellableContinuation, emitter3);
        }
        int i = 0;
    ...
    public final void enqueueLocked(Object item) {
        ...
        SharedFlowKt.setBufferAt(objArr, getHead() + ((long) totalSize), item);
    }
    ...
    private final Object getPeekedValueLockedAt(long index) {
        Object[] objArr = this.buffer;
        Intrinsics.checkNotNull(objArr);
        Object access$getBufferAt = SharedFlowKt.getBufferAt(objArr, index);
    ...
    private final Object[] growBuffer(Object[] curBuffer, int curSize, int newSize) {
        ...
        if (newSize > 0) {
            ...
            while (i < curSize) {
                int i2 = i;
                i++;
                SharedFlowKt.setBufferAt(objArr, ((long) i2) + head, SharedFlowKt.getBufferAt(curBuffer, ((long) i2) + head));
            }
            return objArr;
        }
    ...
    private final void updateBufferLocked(long newReplayIndex, long newMinCollectorIndex, long newBufferEndIndex, long newQueueEndIndex) {
        ...
        while (head < min) {
            ...
            Object[] objArr = this.buffer;
            Intrinsics.checkNotNull(objArr);
            SharedFlowKt.setBufferAt(objArr, j3, (Object) null);
        }
        this.replayIndex = j;
