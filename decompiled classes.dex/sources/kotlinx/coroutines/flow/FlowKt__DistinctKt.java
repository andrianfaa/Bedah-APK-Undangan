...
final /* synthetic */ class FlowKt__DistinctKt {
    ...
    public static final <T> Flow<T> distinctUntilChanged(Flow<? extends T> $this$distinctUntilChanged) {
        return $this$distinctUntilChanged instanceof StateFlow ? $this$distinctUntilChanged : distinctUntilChangedBy$FlowKt__DistinctKt($this$distinctUntilChanged, defaultKeySelector, defaultAreEquivalent);
    }
    ...
    private static final <T> Flow<T> distinctUntilChangedBy$FlowKt__DistinctKt(Flow<? extends T> $this$distinctUntilChangedBy, Function1<? super T, ? extends Object> keySelector, Function2<Object, Object, Boolean> areEquivalent) {
        return (($this$distinctUntilChangedBy instanceof DistinctFlowImpl) && ((DistinctFlowImpl) $this$distinctUntilChangedBy).keySelector == keySelector && ((DistinctFlowImpl) $this$distinctUntilChangedBy).areEquivalent == areEquivalent) ? $this$distinctUntilChangedBy : new DistinctFlowImpl<>($this$distinctUntilChangedBy, keySelector, areEquivalent);
    }
