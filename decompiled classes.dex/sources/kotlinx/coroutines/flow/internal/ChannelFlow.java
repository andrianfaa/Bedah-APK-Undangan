...
public abstract class ChannelFlow<T> implements FusibleFlow<T> {
    ...
    public Flow<T> fuse(CoroutineContext context2, int capacity2, BufferOverflow onBufferOverflow2) {
        ...
        CoroutineContext plus = context2.plus(this.context);
        ...
        return (Intrinsics.areEqual((Object) plus, (Object) this.context) && i == this.capacity && bufferOverflow == this.onBufferOverflow) ? this : create(plus, i, bufferOverflow);
    }
    ...
    public String toString() {
        ...
        if (this.context != EmptyCoroutineContext.INSTANCE) {
            String stringPlus = Intrinsics.stringPlus("context=", this.context);
            Log1F380D.a((Object) stringPlus);
            arrayList.add(stringPlus);
        }
        int i = this.capacity;
        if (i != -3) {
            String stringPlus2 = Intrinsics.stringPlus("capacity=", Integer.valueOf(i));
            Log1F380D.a((Object) stringPlus2);
            arrayList.add(stringPlus2);
        }
        if (this.onBufferOverflow != BufferOverflow.SUSPEND) {
            String stringPlus3 = Intrinsics.stringPlus("onBufferOverflow=", this.onBufferOverflow);
