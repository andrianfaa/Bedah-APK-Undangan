...
public final class SafeCollector<T> extends ContinuationImpl implements FlowCollector<T>, CoroutineStackFrame {
    ...
    private final Object emit(Continuation<? super Unit> uCont, T value) {
        ...
        Object invoke = SafeCollectorKt.emitFun.invoke(this.collector, value, this);
    ...
    public Object emit(T value, Continuation<? super Unit> $completion) {
        ...
        try {
            Object emit = emit(continuation, value);
    ...
    public Object invokeSuspend(Object result) {
        Throwable r0 = Result.m39exceptionOrNullimpl(result);
        if (r0 != null) {
