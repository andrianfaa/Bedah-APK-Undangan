...
public final class ChannelLimitedFlowMerge<T> extends ChannelFlow<T> {
    ...
    public Object collectTo(ProducerScope<? super T> scope, Continuation<? super Unit> $completion) {
        SendingCollector sendingCollector = new SendingCollector(scope);
        for (Flow<T> channelLimitedFlowMerge$collectTo$2$1 : this.flows) {
            Job unused = BuildersKt__Builders_commonKt.launch$default(scope, (CoroutineContext) null, (CoroutineStart) null, new ChannelLimitedFlowMerge$collectTo$2$1(channelLimitedFlowMerge$collectTo$2$1, sendingCollector, (Continuation<? super ChannelLimitedFlowMerge$collectTo$2$1>) null), 3, (Object) null);
        }
