...
public final class ChannelFlowKt {
    ...
    public static final <T, V> Object withContextUndispatched(CoroutineContext newContext, V value, Object countOrElement, Function2<? super V, ? super Continuation<? super T>, ? extends Object> block, Continuation<? super T> $completion) {
        ...
        Object updateThreadContext = ThreadContextKt.updateThreadContext(newContext, countOrElement);
        try {
            Object invoke = ((Function2) TypeIntrinsics.beforeCheckcastToFunctionOfArity(block, 2)).invoke(value, new StackFrameContinuation(continuation, newContext));
            ThreadContextKt.restoreThreadContext(newContext, updateThreadContext);
    ...
    public static final <T> FlowCollector<T> withUndispatchedContextCollector(FlowCollector<? super T> $this$withUndispatchedContextCollector, CoroutineContext emitContext) {
        return $this$withUndispatchedContextCollector instanceof SendingCollector ? true : $this$withUndispatchedContextCollector instanceof NopCollector ? $this$withUndispatchedContextCollector : new UndispatchedContextCollector<>($this$withUndispatchedContextCollector, emitContext);
    }
}
