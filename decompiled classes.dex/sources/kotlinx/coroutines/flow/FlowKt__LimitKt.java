...
final /* synthetic */ class FlowKt__LimitKt {
    ...
    private static final <T> Object collectWhile$$forInline(Flow<? extends T> $this$collectWhile, Function2<? super T, ? super Continuation<? super Boolean>, ? extends Object> predicate, Continuation<? super Unit> $completion) {
        FlowKt__LimitKt$collectWhile$collector$1 flowKt__LimitKt$collectWhile$collector$1 = new FlowKt__LimitKt$collectWhile$collector$1(predicate);
        try {
            InlineMarker.mark(0);
            $this$collectWhile.collect(flowKt__LimitKt$collectWhile$collector$1, $completion);
            InlineMarker.mark(1);
    ...
    public static final <T> Flow<T> drop(Flow<? extends T> $this$drop, int count) {
        ...
        String stringPlus = Intrinsics.stringPlus("Drop count should be non-negative, but had ", Integer.valueOf(count));
