...
final class StateFlowImpl<T> extends AbstractSharedFlow<StateFlowSlot> implements MutableStateFlow<T>, CancellableFlow<T>, FusibleFlow<T> {
    ...
    /* JADX WARNING: Code restructure failed: missing block: B:33:0x00b4, code lost:
        if (kotlin.jvm.internal.Intrinsics.areEqual(r11, r6) != false) goto L_0x00d5;
     */
    /* JADX WARNING: Code restructure failed: missing block: B:35:0x00b9, code lost:
        if (r6 != kotlinx.coroutines.flow.internal.NullSurrogateKt.NULL) goto L_0x00bd;
     */
    ...
    /* JADX WARNING: Code restructure failed: missing block: B:39:0x00cf, code lost:
        if (r4.emit(r8, r12) != r1) goto L_0x00d2;
     */
    ...
    /* JADX WARNING: Code restructure failed: missing block: B:44:0x00d9, code lost:
        if (r3.takePending() != false) goto L_0x00a5;
     */
    ...
    /* JADX WARNING: Code restructure failed: missing block: B:46:0x00ec, code lost:
        if (r3.awaitPending(r12) != r1) goto L_0x00a5;
     */
    ...
    public java.lang.Object collect(kotlinx.coroutines.flow.FlowCollector<? super T> r11, kotlin.coroutines.Continuation<?> r12) {
        ...
        L_0x002d:
            ...
            kotlin.ResultKt.throwOnFailure(r0)     // Catch:{ all -> 0x00f0 }
            goto L_0x00ef
        L_0x0044:
            java.lang.Object r11 = r12.L$4
            java.lang.Object r2 = r12.L$3
        ...
        L_0x006e:
            ...
            r3 = r11
            kotlinx.coroutines.flow.StateFlowSlot r3 = (kotlinx.coroutines.flow.StateFlowSlot) r3
            boolean r11 = r4 instanceof kotlinx.coroutines.flow.SubscribedFlowCollector     // Catch:{ all -> 0x00f0 }
            if (r11 == 0) goto L_0x0092
            r11 = r4
            kotlinx.coroutines.flow.SubscribedFlowCollector r11 = (kotlinx.coroutines.flow.SubscribedFlowCollector) r11     // Catch:{ all -> 0x00f0 }
            r12.L$0 = r5     // Catch:{ all -> 0x00f0 }
            r12.L$1 = r4     // Catch:{ all -> 0x00f0 }
            r12.L$2 = r3     // Catch:{ all -> 0x00f0 }
            r2 = 1
            r12.label = r2     // Catch:{ all -> 0x00f0 }
            java.lang.Object r11 = r11.onSubscription(r12)     // Catch:{ all -> 0x00f0 }
            if (r11 != r1) goto L_0x0092
            return r1
        L_0x0092:
            r11 = 0
            kotlin.coroutines.CoroutineContext r2 = r12.getContext()     // Catch:{ all -> 0x00f0 }
            kotlinx.coroutines.Job$Key r11 = kotlinx.coroutines.Job.Key     // Catch:{ all -> 0x00f0 }
            kotlin.coroutines.CoroutineContext$Key r11 = (kotlin.coroutines.CoroutineContext.Key) r11     // Catch:{ all -> 0x00f0 }
            kotlin.coroutines.CoroutineContext$Element r11 = r2.get(r11)     // Catch:{ all -> 0x00f0 }
            kotlinx.coroutines.Job r11 = (kotlinx.coroutines.Job) r11     // Catch:{ all -> 0x00f0 }
            r2 = 0
            r9 = r2
            r2 = r11
            r11 = r9
        L_0x00a5:
            java.lang.Object r6 = r5._state     // Catch:{ all -> 0x00f0 }
            if (r2 != 0) goto L_0x00ab
            goto L_0x00ae
        L_0x00ab:
            kotlinx.coroutines.JobKt.ensureActive((kotlinx.coroutines.Job) r2)     // Catch:{ all -> 0x00f0 }
        L_0x00ae:
            if (r11 == 0) goto L_0x00b6
            boolean r7 = kotlin.jvm.internal.Intrinsics.areEqual((java.lang.Object) r11, (java.lang.Object) r6)     // Catch:{ all -> 0x00f0 }
            if (r7 != 0) goto L_0x00d5
        L_0x00b6:
            kotlinx.coroutines.internal.Symbol r11 = kotlinx.coroutines.flow.internal.NullSurrogateKt.NULL     // Catch:{ all -> 0x00f0 }
            r7 = 0
        ...
        L_0x00be:
            ...
            r12.L$1 = r4     // Catch:{ all -> 0x00f0 }
            r12.L$2 = r3     // Catch:{ all -> 0x00f0 }
            r12.L$3 = r2     // Catch:{ all -> 0x00f0 }
            r12.L$4 = r6     // Catch:{ all -> 0x00f0 }
            r11 = 2
            r12.label = r11     // Catch:{ all -> 0x00f0 }
            java.lang.Object r11 = r4.emit(r8, r12)     // Catch:{ all -> 0x00f0 }
        ...
        L_0x00d3:
            ...
            r11 = r6
        L_0x00d5:
            boolean r6 = r3.takePending()     // Catch:{ all -> 0x00f0 }
            if (r6 != 0) goto L_0x00a5
            r12.L$0 = r5     // Catch:{ all -> 0x00f0 }
            r12.L$1 = r4     // Catch:{ all -> 0x00f0 }
            r12.L$2 = r3     // Catch:{ all -> 0x00f0 }
            r12.L$3 = r2     // Catch:{ all -> 0x00f0 }
            r12.L$4 = r11     // Catch:{ all -> 0x00f0 }
            r6 = 3
            r12.label = r6     // Catch:{ all -> 0x00f0 }
            java.lang.Object r6 = r3.awaitPending(r12)     // Catch:{ all -> 0x00f0 }
