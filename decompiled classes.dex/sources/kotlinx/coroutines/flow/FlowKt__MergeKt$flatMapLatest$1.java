...
public final class FlowKt__MergeKt$flatMapLatest$1 extends SuspendLambda implements Function3<FlowCollector<? super R>, T, Continuation<? super Unit>, Object> {
    ...
    public final Object invokeSuspend(Object obj) {
        ...
        if (FlowKt.emitAll(flowCollector, (Flow) obj, (Continuation<? super Unit>) flowKt__MergeKt$flatMapLatest$1) == coroutine_suspended) {
            return coroutine_suspended;
        }
        Object obj4 = obj2;
    ...
    public final Object invokeSuspend$$forInline(Object $result) {
        Object obj = this.L$1;
        InlineMarker.mark(0);
        FlowKt.emitAll((FlowCollector) this.L$0, (Flow) this.$transform.invoke(obj, this), (Continuation<? super Unit>) this);
        InlineMarker.mark(1);
        return Unit.INSTANCE;
    }
}
