...
public final class WorkQueue {
    ...
    private final long tryStealLastScheduled(WorkQueue victim, boolean blockingOnly) {
        ...
        } while (!AbstractResolvableFuture$SafeAtomicHelper$$ExternalSyntheticBackportWithForwarding0.m(lastScheduledTask$FU, victim, task, (Object) null));
    ...
    public final long tryStealBlockingFrom(WorkQueue victim) {
        ...
        for (int i2 = victim.consumerIndex; i2 != i; i2++) {
            ...
            if (task != null) {
                if ((task.taskContext.getTaskMode() == 1) && ConcurrentWeakMap$Core$$ExternalSyntheticBackportWithForwarding0.m(atomicReferenceArray, i3, task, (Object) null)) {
