...
public final class DelayKt {
    ...
    public static final Object delay(long timeMillis, Continuation<? super Unit> $completion) {
        ...
        if (timeMillis < Long.MAX_VALUE) {
            getDelay(cancellableContinuation.getContext()).scheduleResumeAfterDelay(timeMillis, cancellableContinuation);
        }
    ...
    public static final Object m1513delayVtjQ1oo(long duration, Continuation<? super Unit> $completion) {
        Object delay = delay(m1514toDelayMillisLRDsOJo(duration), $completion);
    ...
    public static final long m1514toDelayMillisLRDsOJo(long $this$toDelayMillis) {
        if (Duration.m1348compareToLRDsOJo($this$toDelayMillis, Duration.Companion.m1451getZEROUwyO8pc()) > 0) {
            return RangesKt.coerceAtLeast(Duration.m1367getInWholeMillisecondsimpl($this$toDelayMillis), 1);
        }
        return 0;
    }
}
