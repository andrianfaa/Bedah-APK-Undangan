...
public final class CoroutineScopeKt {
    ...
    public static final void cancel(CoroutineScope $this$cancel, CancellationException cause) {
        ...
        String stringPlus = Intrinsics.stringPlus("Scope cannot be cancelled because it does not have a job: ", $this$cancel);
    ...
    public static final <R> Object coroutineScope(Function2<? super CoroutineScope, ? super Continuation<? super R>, ? extends Object> block, Continuation<? super R> $completion) {
        Continuation<? super R> continuation = $completion;
        ScopeCoroutine scopeCoroutine = new ScopeCoroutine(continuation.getContext(), continuation);
        Object startUndispatchedOrReturn = UndispatchedKt.startUndispatchedOrReturn(scopeCoroutine, scopeCoroutine, block);
