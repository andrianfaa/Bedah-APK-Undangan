...
public final class Route {
    ...
    public Route(Address address2, Proxy proxy2, InetSocketAddress socketAddress2) {
        ...
        Intrinsics.checkNotNullParameter(socketAddress2, "socketAddress");
    ...
    public final Address m1720deprecated_address() {
        return this.address;
    }

    @Deprecated(level = DeprecationLevel.ERROR, message = "moved to val", replaceWith = @ReplaceWith(expression = "proxy", imports = {}))
    /* renamed from: -deprecated_proxy  reason: not valid java name */
    public final Proxy m1721deprecated_proxy() {
        return this.proxy;
    }
    ...
    public final InetSocketAddress m1722deprecated_socketAddress() {
