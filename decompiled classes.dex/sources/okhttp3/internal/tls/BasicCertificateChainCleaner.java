...
public final class BasicCertificateChainCleaner extends CertificateChainCleaner {
    ...
    public List<Certificate> clean(List<? extends Certificate> chain, String hostname) throws SSLPeerUnverifiedException {
        ...
        Deque arrayDeque = new ArrayDeque(chain);
        ...
        while (i < 9) {
            ...
            if (certificate != null) {
                ...
                if (findByIssuerAndSignature != null) {
                    if (arrayList.size() > 1 || (true ^ Intrinsics.areEqual((Object) x509Certificate, (Object) findByIssuerAndSignature))) {
    ...
    public boolean equals(Object other) {
        ...
        return (other instanceof BasicCertificateChainCleaner) && Intrinsics.areEqual((Object) ((BasicCertificateChainCleaner) other).trustRootIndex, (Object) this.trustRootIndex);
    }
