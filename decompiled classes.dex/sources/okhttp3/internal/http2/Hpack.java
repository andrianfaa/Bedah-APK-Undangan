...
public final class Hpack {
    ...
    public static final class Reader {
            ...
            if (i2 > 0) {
                ...
                while (true) {
                    ...
                    if (length < i || i2 <= 0) {
                        ...
                        System.arraycopy(headerArr, i + 1, headerArr, i + 1 + i3, this.headerCount);
                ...
                System.arraycopy(headerArr2, i + 1, headerArr2, i + 1 + i3, this.headerCount);
                this.nextHeaderIndex += i3;
            }
            return i3;
        }
        ...
        private final void insertIntoDynamicTable(int index, Header entry) {
            ...
            if (i != -1) {
                Header header = this.dynamicTable[dynamicTableIndex(i)];
                Intrinsics.checkNotNull(header);
                i2 -= header.hpackSize;
            }
            ...
            if (i == -1) {
                ...
                this.dynamicTable[i + dynamicTableIndex(i) + evictToRecoverBytes] = entry;
            }
    ...
    public static final class Writer {
        ...
        private final int evictToRecoverBytes(int bytesToRecover) {
            ...
            if (i2 > 0) {
                ...
                System.arraycopy(headerArr3, i + 1, headerArr3, i + 1 + i3, this.headerCount);
        ...
        public final void resizeHeaderTable(int headerTableSizeSetting2) {
            this.headerTableSizeSetting = headerTableSizeSetting2;
            int min = Math.min(headerTableSizeSetting2, 16384);
            int i = this.maxDynamicTableByteCount;
            if (i != min) {
                if (min < i) {
        ...
        public final void writeHeaders(List<Header> headerBlock) throws IOException {
            ...
            for (int i2 = 0; i2 < size; i2++) {
                ...
                if (num != null && 2 <= (i4 = num.intValue() + 1) && 7 >= i4) {
                    if (Intrinsics.areEqual((Object) Hpack.INSTANCE.getSTATIC_HEADER_TABLE()[i4 - 1].value, (Object) byteString)) {
                        i3 = i4;
                    } else if (Intrinsics.areEqual((Object) Hpack.INSTANCE.getSTATIC_HEADER_TABLE()[i4].value, (Object) byteString)) {
                        i3 = i4 + 1;
                    }
                }
                if (i3 == -1) {
                    ...
                    while (true) {
                        ...
                        if (Intrinsics.areEqual((Object) header2.name, (Object) asciiLowercase)) {
                            ...
                            if (Intrinsics.areEqual((Object) header3.value, (Object) byteString)) {
                                i3 = (i5 - this.nextHeaderIndex) + Hpack.INSTANCE.getSTATIC_HEADER_TABLE().length;
                                break;
                            } else if (i4 == -1) {
                                i4 = (i5 - this.nextHeaderIndex) + Hpack.INSTANCE.getSTATIC_HEADER_TABLE().length;
                            }
                        }
                        i5++;
                    }
