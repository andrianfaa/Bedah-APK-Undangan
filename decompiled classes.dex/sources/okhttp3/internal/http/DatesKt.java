...
public final class DatesKt {
    ...
    public static final Date toHttpDateOrNull(String $this$toHttpDateOrNull) {
        ...
        Date parse = ((DateFormat) STANDARD_DATE_FORMAT.get()).parse($this$toHttpDateOrNull, parsePosition);
        if (parsePosition.getIndex() == $this$toHttpDateOrNull.length()) {
            return parse;
        }
        ...
        synchronized (strArr) {
            ...
            for (int i = 0; i < length; i++) {
                ...
                Date parse2 = dateFormat.parse($this$toHttpDateOrNull, parsePosition);
