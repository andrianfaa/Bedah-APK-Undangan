...
public final class AndroidPlatform extends Platform {
    ...
    public static final class CustomTrustRootIndex implements TrustRootIndex {
        ...
        public CustomTrustRootIndex(X509TrustManager trustManager2, Method findByIssuerAndSignatureMethod2) {
            ...
            Intrinsics.checkNotNullParameter(findByIssuerAndSignatureMethod2, "findByIssuerAndSignatureMethod");
    ...
    public TrustRootIndex buildTrustRootIndex(X509TrustManager trustManager) {
        Intrinsics.checkNotNullParameter(trustManager, "trustManager");
        try {
            Method declaredMethod = trustManager.getClass().getDeclaredMethod("findTrustAnchorByIssuerAndSignature", new Class[]{X509Certificate.class});
