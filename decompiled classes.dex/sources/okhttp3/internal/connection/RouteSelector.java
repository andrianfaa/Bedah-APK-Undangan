    ...
    private final void resetNextInetSocketAddress(Proxy proxy) throws IOException {
        ...
        if (proxy.type() == Proxy.Type.DIRECT || proxy.type() == Proxy.Type.SOCKS) {
            ...
            if (address2 instanceof InetSocketAddress) {
                str = Companion.getSocketHost((InetSocketAddress) address2);
                i = ((InetSocketAddress) address2).getPort();
            } else {
        ...
        if (1 > i || 65535 < i) {
            ...
            if (!lookup.isEmpty()) {
                ...
                for (InetAddress inetSocketAddress : lookup) {
                    arrayList.add(new InetSocketAddress(inetSocketAddress, i));
                }
                return;
            }
