...
public final class Dispatcher {
    ...
    private final RealCall.AsyncCall findExistingCallWithHost(String host) {
        ...
        while (it.hasNext()) {
            ...
            if (Intrinsics.areEqual((Object) next.getHost(), (Object) host)) {
                return next;
            }
        }
        ...
        while (it2.hasNext()) {
            ...
            if (Intrinsics.areEqual((Object) next2.getHost(), (Object) host)) {
                return next2;
            }
        }
        return null;
    ...
    public final ExecutorService m1629deprecated_executorService() {
