...
public final class Cache implements Closeable, Flushable {
    ...
    public static final class Companion {
        ...
        public final boolean varyMatches(Response cachedResponse, Headers cachedRequest, Request newRequest) {
            ...
            Iterable<String> varyFields = varyFields(cachedResponse.headers());
            if ((varyFields instanceof Collection) && ((Collection) varyFields).isEmpty()) {
                return true;
            }
            for (String str : varyFields) {
                if (!Intrinsics.areEqual((Object) cachedRequest.values(str), (Object) newRequest.headers(str))) {
                    return false;
                }
            }
            return true;
    ...
    private static final class Entry {
        ...
        public Entry(Source rawSource) throws IOException {
            ...
            try {
                ...
                long j2 = 0;
                if (str2 != null) {
                    StatusLine statusLine = parse;
                    j = Long.parseLong(str2);
                } else {
                    StatusLine statusLine2 = parse;
                    j = 0;
                }
                this.sentRequestMillis = j;
                this.receivedResponseMillis = str4 != null ? Long.parseLong(str4) : j2;
        ...
        private final List<Certificate> readCertificateList(BufferedSource source) throws IOException {
            int readInt$okhttp = Cache.Companion.readInt$okhttp(source);
            if (readInt$okhttp == -1) {
        ...
        private final void writeCertList(BufferedSink sink, List<? extends Certificate> certificates) throws IOException {
            try {
                ...
                for (int i = 0; i < size; i++) {
                    byte[] encoded = ((Certificate) certificates.get(i)).getEncoded();
        ...
        public final void writeTo(okhttp3.internal.cache.DiskLruCache.Editor r12) throws java.io.IOException {
            /*
                ...
                r3 = r1
                okio.BufferedSink r3 = (okio.BufferedSink) r3     // Catch:{ all -> 0x0135 }
                r4 = 0
                java.lang.String r5 = r11.url     // Catch:{ all -> 0x0135 }
                okio.BufferedSink r5 = r3.writeUtf8(r5)     // Catch:{ all -> 0x0135 }
                r6 = 10
                r5.writeByte(r6)     // Catch:{ all -> 0x0135 }
                java.lang.String r5 = r11.requestMethod     // Catch:{ all -> 0x0135 }
                okio.BufferedSink r5 = r3.writeUtf8(r5)     // Catch:{ all -> 0x0135 }
                r5.writeByte(r6)     // Catch:{ all -> 0x0135 }
                okhttp3.Headers r5 = r11.varyHeaders     // Catch:{ all -> 0x0135 }
                int r5 = r5.size()     // Catch:{ all -> 0x0135 }
                long r7 = (long) r5     // Catch:{ all -> 0x0135 }
                okio.BufferedSink r5 = r3.writeDecimalLong(r7)     // Catch:{ all -> 0x0135 }
                r5.writeByte(r6)     // Catch:{ all -> 0x0135 }
                okhttp3.Headers r5 = r11.varyHeaders     // Catch:{ all -> 0x0135 }
                int r5 = r5.size()     // Catch:{ all -> 0x0135 }
                r7 = r0
            L_0x0041:
                ...
                okhttp3.Headers r9 = r11.varyHeaders     // Catch:{ all -> 0x0135 }
                java.lang.String r9 = r9.name(r7)     // Catch:{ all -> 0x0135 }
                okio.BufferedSink r9 = r3.writeUtf8(r9)     // Catch:{ all -> 0x0135 }
                okio.BufferedSink r8 = r9.writeUtf8(r8)     // Catch:{ all -> 0x0135 }
                okhttp3.Headers r9 = r11.varyHeaders     // Catch:{ all -> 0x0135 }
                java.lang.String r9 = r9.value(r7)     // Catch:{ all -> 0x0135 }
                okio.BufferedSink r8 = r8.writeUtf8(r9)     // Catch:{ all -> 0x0135 }
                r8.writeByte(r6)     // Catch:{ all -> 0x0135 }
                int r7 = r7 + 1
                goto L_0x0041
            L_0x006a:
                okhttp3.internal.http.StatusLine r5 = new okhttp3.internal.http.StatusLine     // Catch:{ all -> 0x0135 }
                okhttp3.Protocol r7 = r11.protocol     // Catch:{ all -> 0x0135 }
                int r9 = r11.code     // Catch:{ all -> 0x0135 }
                java.lang.String r10 = r11.message     // Catch:{ all -> 0x0135 }
                r5.<init>(r7, r9, r10)     // Catch:{ all -> 0x0135 }
                java.lang.String r5 = r5.toString()     // Catch:{ all -> 0x0135 }
                okio.BufferedSink r5 = r3.writeUtf8(r5)     // Catch:{ all -> 0x0135 }
                r5.writeByte(r6)     // Catch:{ all -> 0x0135 }
                okhttp3.Headers r5 = r11.responseHeaders     // Catch:{ all -> 0x0135 }
                int r5 = r5.size()     // Catch:{ all -> 0x0135 }
                int r5 = r5 + 2
                long r9 = (long) r5     // Catch:{ all -> 0x0135 }
                okio.BufferedSink r5 = r3.writeDecimalLong(r9)     // Catch:{ all -> 0x0135 }
                r5.writeByte(r6)     // Catch:{ all -> 0x0135 }
                okhttp3.Headers r5 = r11.responseHeaders     // Catch:{ all -> 0x0135 }
                int r5 = r5.size()     // Catch:{ all -> 0x0135 }
            L_0x0096:
                if (r0 >= r5) goto L_0x00bd
                okhttp3.Headers r7 = r11.responseHeaders     // Catch:{ all -> 0x0135 }
                java.lang.String r7 = r7.name(r0)     // Catch:{ all -> 0x0135 }
                okio.BufferedSink r7 = r3.writeUtf8(r7)     // Catch:{ all -> 0x0135 }
                okio.BufferedSink r7 = r7.writeUtf8(r8)     // Catch:{ all -> 0x0135 }
                okhttp3.Headers r9 = r11.responseHeaders     // Catch:{ all -> 0x0135 }
                java.lang.String r9 = r9.value(r0)     // Catch:{ all -> 0x0135 }
                okio.BufferedSink r7 = r7.writeUtf8(r9)     // Catch:{ all -> 0x0135 }
                r7.writeByte(r6)     // Catch:{ all -> 0x0135 }
                int r0 = r0 + 1
                goto L_0x0096
            L_0x00bd:
                java.lang.String r0 = SENT_MILLIS     // Catch:{ all -> 0x0135 }
                okio.BufferedSink r0 = r3.writeUtf8(r0)     // Catch:{ all -> 0x0135 }
                okio.BufferedSink r0 = r0.writeUtf8(r8)     // Catch:{ all -> 0x0135 }
                long r9 = r11.sentRequestMillis     // Catch:{ all -> 0x0135 }
                okio.BufferedSink r0 = r0.writeDecimalLong(r9)     // Catch:{ all -> 0x0135 }
                r0.writeByte(r6)     // Catch:{ all -> 0x0135 }
                java.lang.String r0 = RECEIVED_MILLIS     // Catch:{ all -> 0x0135 }
                okio.BufferedSink r0 = r3.writeUtf8(r0)     // Catch:{ all -> 0x0135 }
                okio.BufferedSink r0 = r0.writeUtf8(r8)     // Catch:{ all -> 0x0135 }
                long r7 = r11.receivedResponseMillis     // Catch:{ all -> 0x0135 }
                okio.BufferedSink r0 = r0.writeDecimalLong(r7)     // Catch:{ all -> 0x0135 }
                r0.writeByte(r6)     // Catch:{ all -> 0x0135 }
                boolean r0 = r11.isHttps()     // Catch:{ all -> 0x0135 }
                if (r0 == 0) goto L_0x012f
                r3.writeByte(r6)     // Catch:{ all -> 0x0135 }
                okhttp3.Handshake r0 = r11.handshake     // Catch:{ all -> 0x0135 }
                kotlin.jvm.internal.Intrinsics.checkNotNull(r0)     // Catch:{ all -> 0x0135 }
                okhttp3.CipherSuite r0 = r0.cipherSuite()     // Catch:{ all -> 0x0135 }
                java.lang.String r0 = r0.javaName()     // Catch:{ all -> 0x0135 }
                okio.BufferedSink r0 = r3.writeUtf8(r0)     // Catch:{ all -> 0x0135 }
                r0.writeByte(r6)     // Catch:{ all -> 0x0135 }
                okhttp3.Handshake r0 = r11.handshake     // Catch:{ all -> 0x0135 }
                java.util.List r0 = r0.peerCertificates()     // Catch:{ all -> 0x0135 }
                r11.writeCertList(r3, r0)     // Catch:{ all -> 0x0135 }
                okhttp3.Handshake r0 = r11.handshake     // Catch:{ all -> 0x0135 }
                java.util.List r0 = r0.localCertificates()     // Catch:{ all -> 0x0135 }
                r11.writeCertList(r3, r0)     // Catch:{ all -> 0x0135 }
                okhttp3.Handshake r0 = r11.handshake     // Catch:{ all -> 0x0135 }
                okhttp3.TlsVersion r0 = r0.tlsVersion()     // Catch:{ all -> 0x0135 }
                java.lang.String r0 = r0.javaName()     // Catch:{ all -> 0x0135 }
                okio.BufferedSink r0 = r3.writeUtf8(r0)     // Catch:{ all -> 0x0135 }
                r0.writeByte(r6)     // Catch:{ all -> 0x0135 }
            L_0x012f:
                kotlin.Unit r0 = kotlin.Unit.INSTANCE     // Catch:{ all -> 0x0135 }
    ...
    private final class RealCacheRequest implements CacheRequest {
        ...
        public RealCacheRequest(Cache this$02, DiskLruCache.Editor editor2) {
    ...
    public final File m1601deprecated_directory() {
