...
public class SupportMenuInflater extends MenuInflater {
    ...
    private class MenuState {
        ...
        private <T> T newInstance(String className, Class<?>[] clsArr, Object[] arguments) {
            try {
                Constructor<?> constructor = Class.forName(className, false, SupportMenuInflater.this.mContext.getClassLoader()).getConstructor(clsArr);
        ...
        public void readGroup(AttributeSet attrs) {
            TypedArray obtainStyledAttributes = SupportMenuInflater.this.mContext.obtainStyledAttributes(attrs, R.styleable.MenuGroup);
        ...
        public void readItem(AttributeSet attrs) {
            TintTypedArray obtainStyledAttributes = TintTypedArray.obtainStyledAttributes(SupportMenuInflater.this.mContext, attrs, R.styleable.MenuItem);
    ...
    private Object findRealOwner(Object owner) {
        return (!(owner instanceof Activity) && (owner instanceof ContextWrapper)) ? findRealOwner(((ContextWrapper) owner).getBaseContext()) : owner;
    }
