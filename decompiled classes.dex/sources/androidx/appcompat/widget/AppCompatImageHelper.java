...
public class AppCompatImageHelper {
    ...
    private boolean applyFrameworkTintUsingColorFilter(Drawable imageSource) {
        ...
        AppCompatDrawableManager.tintDrawable(imageSource, tintInfo, this.mView.getDrawableState());
        return true;
    }
    ...
    public void loadFromAttributes(AttributeSet attrs, int defStyleAttr) {
        int resourceId;
        TintTypedArray obtainStyledAttributes = TintTypedArray.obtainStyledAttributes(this.mView.getContext(), attrs, R.styleable.AppCompatImageView, defStyleAttr, 0);
        ImageView imageView = this.mView;
        ViewCompat.saveAttributeDataForStyleable(imageView, imageView.getContext(), R.styleable.AppCompatImageView, attrs, obtainStyledAttributes.getWrappedTypeArray(), defStyleAttr, 0);
        try {
            Drawable drawable = this.mView.getDrawable();
