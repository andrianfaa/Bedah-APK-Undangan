...
class ActivityChooserModel extends DataSetObservable {
    ...
    private final class PersistHistoryAsyncTask extends AsyncTask<Object, Void, Void> {
        ...
        /* JADX WARNING: Unknown top exception splitter block from list: {B:37:0x00c0=Splitter:B:37:0x00c0, B:29:0x0098=Splitter:B:29:0x0098, B:45:0x00e8=Splitter:B:45:0x00e8} */
        ...
        public java.lang.Void doInBackground(java.lang.Object... r18) {
            /*
                ...
                r8 = 0
                r9 = 0
                androidx.appcompat.widget.ActivityChooserModel r10 = androidx.appcompat.widget.ActivityChooserModel.this     // Catch:{ FileNotFoundException -> 0x011e }
                android.content.Context r10 = r10.mContext     // Catch:{ FileNotFoundException -> 0x011e }
                java.io.FileOutputStream r10 = r10.openFileOutput(r7, r4)     // Catch:{ FileNotFoundException -> 0x011e }
                r8 = r10
                org.xmlpull.v1.XmlSerializer r10 = android.util.Xml.newSerializer()
                r10.setOutput(r8, r9)     // Catch:{ IllegalArgumentException -> 0x00e5, IllegalStateException -> 0x00bd, IOException -> 0x0095, all -> 0x008f }
                java.lang.String r11 = "UTF-8"
                java.lang.Boolean r12 = java.lang.Boolean.valueOf(r6)     // Catch:{ IllegalArgumentException -> 0x00e5, IllegalStateException -> 0x00bd, IOException -> 0x0095, all -> 0x008f }
                r10.startDocument(r11, r12)     // Catch:{ IllegalArgumentException -> 0x00e5, IllegalStateException -> 0x00bd, IOException -> 0x0095, all -> 0x008f }
                r10.startTag(r9, r2)     // Catch:{ IllegalArgumentException -> 0x00e5, IllegalStateException -> 0x00bd, IOException -> 0x0095, all -> 0x008f }
                int r11 = r5.size()     // Catch:{ IllegalArgumentException -> 0x00e5, IllegalStateException -> 0x00bd, IOException -> 0x0095, all -> 0x008f }
                r12 = 0
            L_0x0036:
                if (r12 >= r11) goto L_0x0076
                java.lang.Object r13 = r5.remove(r4)     // Catch:{ IllegalArgumentException -> 0x00e5, IllegalStateException -> 0x00bd, IOException -> 0x0095, all -> 0x008f }
                androidx.appcompat.widget.ActivityChooserModel$HistoricalRecord r13 = (androidx.appcompat.widget.ActivityChooserModel.HistoricalRecord) r13     // Catch:{ IllegalArgumentException -> 0x00e5, IllegalStateException -> 0x00bd, IOException -> 0x0095, all -> 0x008f }
                r10.startTag(r9, r0)     // Catch:{ IllegalArgumentException -> 0x00e5, IllegalStateException -> 0x00bd, IOException -> 0x0095, all -> 0x008f }
                java.lang.String r14 = "activity"
                android.content.ComponentName r15 = r13.activity     // Catch:{ IllegalArgumentException -> 0x00e5, IllegalStateException -> 0x00bd, IOException -> 0x0095, all -> 0x008f }
                java.lang.String r15 = r15.flattenToString()     // Catch:{ IllegalArgumentException -> 0x00e5, IllegalStateException -> 0x00bd, IOException -> 0x0095, all -> 0x008f }
                r10.attribute(r9, r14, r15)     // Catch:{ IllegalArgumentException -> 0x00e5, IllegalStateException -> 0x00bd, IOException -> 0x0095, all -> 0x008f }
                java.lang.String r14 = "time"
                r16 = r5
                long r4 = r13.time     // Catch:{ IllegalArgumentException -> 0x008d, IllegalStateException -> 0x008b, IOException -> 0x0089 }
                java.lang.String r4 = java.lang.String.valueOf(r4)     // Catch:{ IllegalArgumentException -> 0x008d, IllegalStateException -> 0x008b, IOException -> 0x0089 }
                mt.Log1F380D.a((java.lang.Object) r4)
                r10.attribute(r9, r14, r4)     // Catch:{ IllegalArgumentException -> 0x008d, IllegalStateException -> 0x008b, IOException -> 0x0089 }
                java.lang.String r4 = "weight"
                float r5 = r13.weight     // Catch:{ IllegalArgumentException -> 0x008d, IllegalStateException -> 0x008b, IOException -> 0x0089 }
                java.lang.String r5 = java.lang.String.valueOf(r5)     // Catch:{ IllegalArgumentException -> 0x008d, IllegalStateException -> 0x008b, IOException -> 0x0089 }
                mt.Log1F380D.a((java.lang.Object) r5)
                r10.attribute(r9, r4, r5)     // Catch:{ IllegalArgumentException -> 0x008d, IllegalStateException -> 0x008b, IOException -> 0x0089 }
                r10.endTag(r9, r0)     // Catch:{ IllegalArgumentException -> 0x008d, IllegalStateException -> 0x008b, IOException -> 0x0089 }
                int r12 = r12 + 1
                r5 = r16
                r4 = 0
                goto L_0x0036
            L_0x0076:
                r16 = r5
                r10.endTag(r9, r2)     // Catch:{ IllegalArgumentException -> 0x008d, IllegalStateException -> 0x008b, IOException -> 0x0089 }
                r10.endDocument()     // Catch:{ IllegalArgumentException -> 0x008d, IllegalStateException -> 0x008b, IOException -> 0x0089 }
                ...
                r8.close()     // Catch:{ IOException -> 0x010d }
                goto L_0x010c
            L_0x0089:
                r0 = move-exception
                goto L_0x0098
            ...
            L_0x0095:
                ...
                r16 = r5
            L_0x0098:
                java.lang.String r2 = androidx.appcompat.widget.ActivityChooserModel.LOG_TAG     // Catch:{ all -> 0x0110 }
                java.lang.StringBuilder r4 = new java.lang.StringBuilder     // Catch:{ all -> 0x0110 }
                r4.<init>()     // Catch:{ all -> 0x0110 }
                java.lang.StringBuilder r3 = r4.append(r3)     // Catch:{ all -> 0x0110 }
                androidx.appcompat.widget.ActivityChooserModel r4 = androidx.appcompat.widget.ActivityChooserModel.this     // Catch:{ all -> 0x0110 }
                java.lang.String r4 = r4.mHistoryFileName     // Catch:{ all -> 0x0110 }
                java.lang.StringBuilder r3 = r3.append(r4)     // Catch:{ all -> 0x0110 }
                java.lang.String r3 = r3.toString()     // Catch:{ all -> 0x0110 }
                android.util.Log.e(r2, r3, r0)     // Catch:{ all -> 0x0110 }
                androidx.appcompat.widget.ActivityChooserModel r0 = androidx.appcompat.widget.ActivityChooserModel.this
                r0.mCanReadHistoricalData = r6
                if (r8 == 0) goto L_0x010f
                r8.close()     // Catch:{ IOException -> 0x010d }
    ...
    public static ActivityChooserModel get(Context context, String historyFileName) {
        ...
        synchronized (sRegistryLock) {
            ...
            activityChooserModel = map.get(historyFileName);
            if (activityChooserModel == null) {
                activityChooserModel = new ActivityChooserModel(context, historyFileName);
                map.put(historyFileName, activityChooserModel);
            }
        }
    ...
    public int getActivityIndex(ResolveInfo activity) {
        synchronized (this.mInstanceLock) {
            ...
            int size = list.size();
            for (int i = 0; i < size; i++) {
                if (list.get(i).resolveInfo == activity) {
                    return i;
                }
            }
            return -1;
