...
public final class AnimatorKt {
    public static final Animator.AnimatorListener addListener(Animator $this$addListener, Function1<? super Animator, Unit> onEnd, Function1<? super Animator, Unit> onStart, Function1<? super Animator, Unit> onCancel, Function1<? super Animator, Unit> onRepeat) {
        ...
        $this$addListener.addListener(animatorKt$addListener$listener$1);
    ...
    public static /* synthetic */ Animator.AnimatorListener addListener$default(Animator $this$addListener_u24default, Function1 onEnd, Function1 onStart, Function1 onCancel, Function1 onRepeat, int i, Object obj) {
        ...
        Intrinsics.checkNotNullParameter(onRepeat, "onRepeat");
        AnimatorKt$addListener$listener$1 animatorKt$addListener$listener$1 = new AnimatorKt$addListener$listener$1(onRepeat, onEnd, onCancel, onStart);
        $this$addListener_u24default.addListener(animatorKt$addListener$listener$1);
        return animatorKt$addListener$listener$1;
    }
    ...
    public static final Animator.AnimatorPauseListener addPauseListener(Animator $this$addPauseListener, Function1<? super Animator, Unit> onResume, Function1<? super Animator, Unit> onPause) {
        ...
        $this$addPauseListener.addPauseListener(animatorKt$addPauseListener$listener$1);
    ...
    public static /* synthetic */ Animator.AnimatorPauseListener addPauseListener$default(Animator $this$addPauseListener_u24default, Function1 onResume, Function1 onPause, int i, Object obj) {
        ...
        Intrinsics.checkNotNullParameter(onPause, "onPause");
        AnimatorKt$addPauseListener$listener$1 animatorKt$addPauseListener$listener$1 = new AnimatorKt$addPauseListener$listener$1(onPause, onResume);
        $this$addPauseListener_u24default.addPauseListener(animatorKt$addPauseListener$listener$1);
        return animatorKt$addPauseListener$listener$1;
    }
    ...
    public static final Animator.AnimatorListener doOnCancel(Animator $this$doOnCancel, Function1<? super Animator, Unit> action) {
        ...
        AnimatorKt$doOnCancel$$inlined$addListener$default$1 animatorKt$doOnCancel$$inlined$addListener$default$1 = new AnimatorKt$doOnCancel$$inlined$addListener$default$1(action);
        $this$doOnCancel.addListener(animatorKt$doOnCancel$$inlined$addListener$default$1);
    ...
    public static final Animator.AnimatorListener doOnEnd(Animator $this$doOnEnd, Function1<? super Animator, Unit> action) {
        ...
        Intrinsics.checkNotNullParameter(action, "action");
        AnimatorKt$doOnEnd$$inlined$addListener$default$1 animatorKt$doOnEnd$$inlined$addListener$default$1 = new AnimatorKt$doOnEnd$$inlined$addListener$default$1(action);
        $this$doOnEnd.addListener(animatorKt$doOnEnd$$inlined$addListener$default$1);
    ...
    public static final Animator.AnimatorPauseListener doOnPause(Animator $this$doOnPause, Function1<? super Animator, Unit> action) {
        ...
        Intrinsics.checkNotNullParameter(action, "action");
        AnimatorKt$doOnPause$$inlined$addPauseListener$default$1 animatorKt$doOnPause$$inlined$addPauseListener$default$1 = new AnimatorKt$doOnPause$$inlined$addPauseListener$default$1(action);
        $this$doOnPause.addPauseListener(animatorKt$doOnPause$$inlined$addPauseListener$default$1);
    ...
    public static final Animator.AnimatorListener doOnRepeat(Animator $this$doOnRepeat, Function1<? super Animator, Unit> action) {
        ...
        Intrinsics.checkNotNullParameter(action, "action");
        AnimatorKt$doOnRepeat$$inlined$addListener$default$1 animatorKt$doOnRepeat$$inlined$addListener$default$1 = new AnimatorKt$doOnRepeat$$inlined$addListener$default$1(action);
        $this$doOnRepeat.addListener(animatorKt$doOnRepeat$$inlined$addListener$default$1);
    ...
    public static final Animator.AnimatorPauseListener doOnResume(Animator $this$doOnResume, Function1<? super Animator, Unit> action) {
        ...
        Intrinsics.checkNotNullParameter(action, "action");
        AnimatorKt$doOnResume$$inlined$addPauseListener$default$1 animatorKt$doOnResume$$inlined$addPauseListener$default$1 = new AnimatorKt$doOnResume$$inlined$addPauseListener$default$1(action);
        $this$doOnResume.addPauseListener(animatorKt$doOnResume$$inlined$addPauseListener$default$1);
    ...
    public static final Animator.AnimatorListener doOnStart(Animator $this$doOnStart, Function1<? super Animator, Unit> action) {
        ...
        Intrinsics.checkNotNullParameter(action, "action");
        AnimatorKt$doOnStart$$inlined$addListener$default$1 animatorKt$doOnStart$$inlined$addListener$default$1 = new AnimatorKt$doOnStart$$inlined$addListener$default$1(action);
        $this$doOnStart.addListener(animatorKt$doOnStart$$inlined$addListener$default$1);
