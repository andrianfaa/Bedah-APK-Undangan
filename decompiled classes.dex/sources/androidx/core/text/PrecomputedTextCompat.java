...
public class PrecomputedTextCompat implements Spannable {
    ...
    public static PrecomputedTextCompat create(CharSequence text, Params params) {
        ...
        try {
            ...
            PrecomputedTextCompat precomputedTextCompat = new PrecomputedTextCompat(text, params, iArr);
    ...
    public int getParagraphEnd(int paraIndex) {
        ...
        return Build.VERSION.SDK_INT >= 29 ? this.mWrapped.getParagraphEnd(paraIndex) : this.mParagraphEnds[paraIndex];
    }
    ...
    public <T> T[] getSpans(int start, int end, Class<T> cls) {
        return Build.VERSION.SDK_INT >= 29 ? this.mWrapped.getSpans(start, end, cls) : this.mText.getSpans(start, end, cls);
    }
