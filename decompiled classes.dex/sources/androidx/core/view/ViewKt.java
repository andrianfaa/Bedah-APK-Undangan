...
public final class ViewKt {
    ...
    public static final Bitmap drawToBitmap(View $this$drawToBitmap, Bitmap.Config config) {
        ...
        if (ViewCompat.isLaidOut($this$drawToBitmap)) {
            Bitmap createBitmap = Bitmap.createBitmap($this$drawToBitmap.getWidth(), $this$drawToBitmap.getHeight(), config);
            Intrinsics.checkNotNullExpressionValue(createBitmap, "createBitmap(width, height, config)");
            Canvas canvas = new Canvas(createBitmap);
            canvas.translate(-((float) $this$drawToBitmap.getScrollX()), -((float) $this$drawToBitmap.getScrollY()));
            $this$drawToBitmap.draw(canvas);
            return createBitmap;
        }
    ...
    public static final Runnable postDelayed(View $this$postDelayed, long delayInMillis, Function0<Unit> action) {
        ...
        Intrinsics.checkNotNullParameter(action, "action");
        Runnable viewKt$postDelayed$runnable$1 = new ViewKt$postDelayed$runnable$1(action);
        $this$postDelayed.postDelayed(viewKt$postDelayed$runnable$1, delayInMillis);
    ...
    public static final Runnable postOnAnimationDelayed(View $this$postOnAnimationDelayed, long delayInMillis, Function0<Unit> action) {
        ...
        Intrinsics.checkNotNullParameter(action, "action");
        Runnable viewKt$postOnAnimationDelayed$runnable$1 = new ViewKt$postOnAnimationDelayed$runnable$1(action);
        $this$postOnAnimationDelayed.postOnAnimationDelayed(viewKt$postOnAnimationDelayed$runnable$1, delayInMillis);
    ...
    public static final void updateLayoutParams(View $this$updateLayoutParams, Function1<? super ViewGroup.LayoutParams, Unit> block) {
        ...
        View view = $this$updateLayoutParams;
    ...
    public static final /* synthetic */ <T extends ViewGroup.LayoutParams> void updateLayoutParamsTyped(View $this$updateLayoutParams, Function1<? super T, Unit> block) {
        ...
        $this$updateLayoutParams.setLayoutParams(layoutParams2);
    }
