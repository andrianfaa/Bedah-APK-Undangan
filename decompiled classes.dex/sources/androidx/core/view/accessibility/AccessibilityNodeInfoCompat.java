...
public class AccessibilityNodeInfoCompat {
    ...
    public static class AccessibilityActionCompat {
        ...
        public static final AccessibilityActionCompat ACTION_HIDE_TOOLTIP = new AccessibilityActionCompat(Build.VERSION.SDK_INT >= 28 ? AccessibilityNodeInfo.AccessibilityAction.ACTION_HIDE_TOOLTIP : null, 16908357, (CharSequence) null, (AccessibilityViewCommand) null, (Class<? extends AccessibilityViewCommand.CommandArguments>) null);
        ...
        public static final AccessibilityActionCompat ACTION_PRESS_AND_HOLD = new AccessibilityActionCompat(Build.VERSION.SDK_INT >= 30 ? AccessibilityNodeInfo.AccessibilityAction.ACTION_PRESS_AND_HOLD : null, 16908362, (CharSequence) null, (AccessibilityViewCommand) null, (Class<? extends AccessibilityViewCommand.CommandArguments>) null);
        ...
        private AccessibilityActionCompat(int actionId, CharSequence label, Class<? extends AccessibilityViewCommand.CommandArguments> cls) {
            this((Object) null, actionId, label, (AccessibilityViewCommand) null, cls);
        }
        ...
        AccessibilityActionCompat(Object action, int id, CharSequence label, AccessibilityViewCommand command, Class<? extends AccessibilityViewCommand.CommandArguments> cls) {
            this.mId = id;
        ...
        public boolean perform(View view, Bundle arguments) {
            ...
            if (cls != null) {
                try {
                    ...
                    commandArguments.setBundle(arguments);
                } catch (Exception e) {
    ...
    public static class CollectionItemInfoCompat {
        ...
        public static CollectionItemInfoCompat obtain(int rowIndex, int rowSpan, int columnIndex, int columnSpan, boolean heading) {
            return Build.VERSION.SDK_INT >= 19 ? new CollectionItemInfoCompat(AccessibilityNodeInfo.CollectionItemInfo.obtain(rowIndex, rowSpan, columnIndex, columnSpan, heading)) : new CollectionItemInfoCompat((Object) null);
        }
        ...
        public static CollectionItemInfoCompat obtain(int rowIndex, int rowSpan, int columnIndex, int columnSpan, boolean heading, boolean selected) {
            return Build.VERSION.SDK_INT >= 21 ? new CollectionItemInfoCompat(AccessibilityNodeInfo.CollectionItemInfo.obtain(rowIndex, rowSpan, columnIndex, columnSpan, heading, selected)) : Build.VERSION.SDK_INT >= 19 ? new CollectionItemInfoCompat(AccessibilityNodeInfo.CollectionItemInfo.obtain(rowIndex, rowSpan, columnIndex, columnSpan, heading)) : new CollectionItemInfoCompat((Object) null);
        }
    ...
    public static class RangeInfoCompat {
        ...
        public static RangeInfoCompat obtain(int type, float min, float max, float current) {
            return Build.VERSION.SDK_INT >= 19 ? new RangeInfoCompat(AccessibilityNodeInfo.RangeInfo.obtain(type, min, max, current)) : new RangeInfoCompat((Object) null);
        }
    ...
    private int idForClickableSpan(ClickableSpan span, SparseArray<WeakReference<ClickableSpan>> sparseArray) {
        if (sparseArray != null) {
            for (int i = 0; i < sparseArray.size(); i++) {
                if (span.equals((ClickableSpan) sparseArray.valueAt(i).get())) {
    ...
    private void setBooleanProperty(int property, boolean value) {
        ...
        if (extras != null) {
            int i = 0;
            int i2 = extras.getInt(BOOLEAN_PROPERTY_KEY, 0) & (~property);
            if (value) {
                i = property;
            }
    ...
    public CharSequence getText() {
        ...
        String substring = TextUtils.substring(this.mInfo.getText(), 0, this.mInfo.getText().length());
    ...
    public String toString() {
        ...
        if (Build.VERSION.SDK_INT >= 21) {
            ...
            for (int i = 0; i < actionList.size(); i++) {
                ...
                Log1F380D.a((Object) actionSymbolicName);
            ...
            while (actions != 0) {
                ...
                String actionSymbolicName2 = getActionSymbolicName(numberOfTrailingZeros);
                Log1F380D.a((Object) actionSymbolicName2);
                sb.append(actionSymbolicName2);
                if (actions != 0) {
                    sb.append(", ");
                }
            }
