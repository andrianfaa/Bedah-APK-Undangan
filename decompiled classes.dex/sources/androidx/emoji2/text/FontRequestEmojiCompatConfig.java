    ...
    private static class FontRequestMetadataLoader implements EmojiCompat.MetadataRepoLoader {
        ...
        public void createMetadata() {
            /*
                ...
                monitor-enter(r0)
                androidx.emoji2.text.EmojiCompat$MetadataRepoLoaderCallback r1 = r7.mCallback     // Catch:{ all -> 0x00ac }
            ...
            L_0x0034:
                ...
                androidx.core.os.TraceCompat.endSection()     // Catch:{ all -> 0x0098 }
                java.lang.Object r2 = r7.mLock     // Catch:{ all -> 0x0098 }
                monitor-enter(r2)     // Catch:{ all -> 0x0098 }
            ...
            L_0x0098:
                ...
                monitor-enter(r2)
                androidx.emoji2.text.EmojiCompat$MetadataRepoLoaderCallback r0 = r7.mCallback     // Catch:{ all -> 0x00a9 }
