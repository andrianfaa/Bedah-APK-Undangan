...
public final class SavedStateViewModelFactoryKt {
    ...
    public static final <T> Constructor<T> findMatchingConstructor(Class<T> modelClass, List<? extends Class<?>> signature) {
        ...
        Constructor<T>[] constructors = modelClass.getConstructors();
        ...
        while (i < length) {
            ...
            List list = ArraysKt.toList((T[]) (Object[]) parameterTypes);
            if (Intrinsics.areEqual((Object) signature, (Object) list)) {
                if (constructor != null) {
                    return constructor;
                }
