        ...
        public static void read(KeyTrigger c, TypedArray a, Context context) {
            ...
            for (int i = 0; i < indexCount; i++) {
                ...
                switch (mAttrMap.get(index)) {
                    case 1:
                        String unused = c.mNegativeCross = a.getString(index);
                        break;
                    case 2:
                        String unused2 = c.mPositiveCross = a.getString(index);
                        break;
                    case 4:
                        String unused3 = c.mCross = a.getString(index);
                        break;
                    case 5:
                        c.mTriggerSlack = a.getFloat(index, c.mTriggerSlack);
                        break;
                    case 6:
                        int unused4 = c.mTriggerID = a.getResourceId(index, c.mTriggerID);
                        break;
                    case 7:
                    ...
                    case 8:
                        ...
                        break;
                    case 9:
                        int unused6 = c.mTriggerCollisionId = a.getResourceId(index, c.mTriggerCollisionId);
                        break;
                    case 10:
                        boolean unused7 = c.mPostLayout = a.getBoolean(index, c.mPostLayout);
                        break;
                    case 11:
                        int unused8 = c.mTriggerReceiver = a.getResourceId(index, c.mTriggerReceiver);
                        break;
                    case 12:
