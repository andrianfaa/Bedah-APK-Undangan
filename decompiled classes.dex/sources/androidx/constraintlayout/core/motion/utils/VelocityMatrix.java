...
public class VelocityMatrix {
    ...
    public void applyTransform(float locationX, float locationY, int width, int height, float[] mAnchorDpDt) {
        ...
        float f3 = (locationX - 0.5f) * 2.0f;
        float f4 = (locationY - 0.5f) * 2.0f;
        float f5 = f + this.mDTranslateX;
        float f6 = f2 + this.mDTranslateY;
        float f7 = f5 + (this.mDScaleX * f3);
        float f8 = f6 + (this.mDScaleY * f4);
        float radians = (float) Math.toRadians((double) this.mRotate);
        float radians2 = (float) Math.toRadians((double) this.mDRotate);
        mAnchorDpDt[0] = f7 + (((float) ((((double) (((float) (-i)) * f3)) * Math.sin((double) radians)) - (((double) (((float) i2) * f4)) * Math.cos((double) radians)))) * radians2);
        mAnchorDpDt[1] = f8 + (((float) ((((double) (((float) i) * f3)) * Math.cos((double) radians)) - (((double) (((float) i2) * f4)) * Math.sin((double) radians)))) * radians2);
    }
