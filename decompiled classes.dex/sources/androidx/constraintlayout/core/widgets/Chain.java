...
public class Chain {
    ...
    /* JADX WARNING: Removed duplicated region for block: B:313:0x069a  */
    /* JADX WARNING: Removed duplicated region for block: B:316:0x06a6  */
    /* JADX WARNING: Removed duplicated region for block: B:317:0x06ab  */
    /* JADX WARNING: Removed duplicated region for block: B:320:0x06b1  */
    /* JADX WARNING: Removed duplicated region for block: B:321:0x06b6  */
    /* JADX WARNING: Removed duplicated region for block: B:323:0x06b9  */
    /* JADX WARNING: Removed duplicated region for block: B:328:0x06d1  */
    /* JADX WARNING: Removed duplicated region for block: B:330:0x06d5  */
    /* JADX WARNING: Removed duplicated region for block: B:331:0x06e2  */
    /* JADX WARNING: Removed duplicated region for block: B:333:0x06e6 A[ADDED_TO_REGION] */
    ...
    public static void applyChainConstraints(ConstraintWidgetContainer constraintWidgetContainer, LinearSystem system, ArrayList<ConstraintWidget> arrayList, int orientation) {
        ...
        if (orientation == 0) {
            i2 = 0;
            i = constraintWidgetContainer.mHorizontalChainsSize;
            chainHeadArr = constraintWidgetContainer.mHorizontalChainsArray;
        } else {
            i2 = 2;
            i = constraintWidgetContainer.mVerticalChainsSize;
        ...
        for (int i3 = 0; i3 < i; i3++) {
            ...
            if (arrayList == null || (arrayList != null && arrayList.contains(chainHead.mFirst))) {
                applyChainConstraints(constraintWidgetContainer, system, orientation, i2, chainHead);
            }
        }
    }
}
