...
class SequencesKt__SequencesKt extends SequencesKt__SequencesJVMKt {
    ...
    private static final <T, R> Sequence<R> flatten$SequencesKt__SequencesKt(Sequence<? extends T> $this$flatten, Function1<? super T, ? extends Iterator<? extends R>> iterator) {
        return $this$flatten instanceof TransformingSequence ? ((TransformingSequence) $this$flatten).flatten$kotlin_stdlib(iterator) : new FlatteningSequence<>($this$flatten, SequencesKt__SequencesKt$flatten$3.INSTANCE, iterator);
    }
    ...
    public static final <T> Sequence<T> generateSequence(T seed, Function1<? super T, ? extends T> nextFunction) {
        ...
        return seed == null ? EmptySequence.INSTANCE : new GeneratorSequence<>(new SequencesKt__SequencesKt$generateSequence$2(seed), nextFunction);
    }
