...
public final class SequencesKt___SequencesKt$minus$3 implements Sequence<T> {
    ...
    public Iterator<T> iterator() {
        ...
        return convertToSetForSetOperation.isEmpty() ? this.$this_minus.iterator() : SequencesKt.filterNot(this.$this_minus, new SequencesKt___SequencesKt$minus$3$iterator$1(convertToSetForSetOperation)).iterator();
    }
}
