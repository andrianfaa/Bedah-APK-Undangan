...
public final class TypeReference implements KType {
    ...
    public final String asString(KTypeProjection $this$asString) {
        ...
        if (typeReference == null || (str = typeReference.asString(true)) == null) {
            str = String.valueOf($this$asString.getType());
    ...
    private final String asString(boolean convertPrimitiveToWrapper) {
        ...
        if (cls2 == null) {
            ...
            str = getArrayClassName(cls2);
        } else if (!convertPrimitiveToWrapper || !cls2.isPrimitive()) {
            str = cls2.getName();
        } else {
        ...
        if (kType instanceof TypeReference) {
            ...
            if (!Intrinsics.areEqual((Object) asString, (Object) str4)) {
                return Intrinsics.areEqual((Object) asString, (Object) new StringBuilder().append(str4).append('?').toString()) ? str4 + '!' : '(' + str4 + ".." + asString + ')';
            }
        }
        return str4;
    }
