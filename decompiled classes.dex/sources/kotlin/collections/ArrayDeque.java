...
public final class ArrayDeque<E> extends AbstractMutableList<E> {
    ...
    private final void copyCollectionElements(int internalIndex, Collection<? extends E> elements) {
        ...
        for (int i = internalIndex; i < length && it.hasNext(); i++) {
    ...
    private final void copyElements(int newCapacity) {
        ...
        int i = this.head;
        ArraysKt.copyInto((T[]) objArr3, (T[]) objArr, length - i, 0, i);
        this.head = 0;
        this.elementData = objArr;
    }
        ...
        if (index == size()) {
            ...
            if (index < ((size() + 1) >> 1)) {
                ...
                if (decremented >= i) {
                    ...
                    ArraysKt.copyInto((T[]) objArr, (T[]) objArr, i, i + 1, decremented + 1);
                } else {
                    Object[] objArr2 = this.elementData;
    ...
    public boolean addAll(int index, Collection<? extends E> elements) {
        ...
        if (index < ((size() + 1) >> 1)) {
            ...
            if (positiveMod2 < i) {
                Object[] objArr = this.elementData;
                ArraysKt.copyInto((T[]) objArr, (T[]) objArr, i2, i, objArr.length);
                ...
                Object[] objArr5 = this.elementData;
                ArraysKt.copyInto((T[]) objArr5, (T[]) objArr5, i2, i, positiveMod2);
            } else {
                Object[] objArr6 = this.elementData;
                i2 += objArr6.length;
                ...
                if (length >= i3) {
                    ArraysKt.copyInto((T[]) objArr6, (T[]) objArr6, i2, i, positiveMod2);
                } else {
                    ArraysKt.copyInto((T[]) objArr6, (T[]) objArr6, i2, i, i + length);
                    Object[] objArr7 = this.elementData;
                    ArraysKt.copyInto((T[]) objArr7, (T[]) objArr7, 0, this.head + length, positiveMod2);
                }
            }
            this.head = i2;
            copyCollectionElements(negativeMod(positiveMod2 - size2), elements);
        } else {
            int i4 = positiveMod2 + size2;
            if (positiveMod2 < positiveMod) {
                int i5 = positiveMod + size2;
                Object[] objArr8 = this.elementData;
                if (i5 <= objArr8.length) {
                    ArraysKt.copyInto((T[]) objArr8, (T[]) objArr8, i4, positiveMod2, positiveMod);
                } else if (i4 >= objArr8.length) {
                    ArraysKt.copyInto((T[]) objArr8, (T[]) objArr8, i4 - objArr8.length, positiveMod2, positiveMod);
                } else {
                    int length2 = (positiveMod + size2) - objArr8.length;
                    ArraysKt.copyInto((T[]) objArr8, (T[]) objArr8, 0, positiveMod - length2, positiveMod);
                    Object[] objArr9 = this.elementData;
                    ArraysKt.copyInto((T[]) objArr9, (T[]) objArr9, i4, positiveMod2, positiveMod - length2);
                }
            } else {
                ...
                if (i4 >= objArr11.length) {
                    ArraysKt.copyInto((T[]) objArr11, (T[]) objArr11, i4 - objArr11.length, positiveMod2, objArr11.length);
                } else {
                    ArraysKt.copyInto((T[]) objArr11, (T[]) objArr11, 0, objArr11.length - size2, objArr11.length);
                    Object[] objArr12 = this.elementData;
                    ArraysKt.copyInto((T[]) objArr12, (T[]) objArr12, i4, positiveMod2, objArr12.length - size2);
                }
            }
        ...
        if (i < positiveMod) {
            ...
            for (int i4 = 0; i4 < positiveMod; i4++) {
                if (Intrinsics.areEqual(element, this.elementData[i4])) {
                    return (this.elementData.length + i4) - this.head;
                }
            }
            return -1;
        }
    ...
    public int lastIndexOf(Object element) {
        ...
        if (i < positiveMod) {
            ...
            for (int i3 = positiveMod - 1; -1 < i3; i3--) {
                if (Intrinsics.areEqual(element, this.elementData[i3])) {
                    return (this.elementData.length + i3) - this.head;
                }
            }
        ...
        if (!isEmpty()) {
            if (!(this.elementData.length == 0)) {
                ...
                if (this.head < positiveMod) {
                    ...
                    ArraysKt.fill((T[]) this.elementData, null, i2, positiveMod);
                    i = i2;
                    z = z2;
                } else {
                    int length = this.elementData.length;
    ...
    public E removeAt(int index) {
        ...
        if (index < (size() >> 1)) {
            ...
            if (positiveMod >= i) {
                Object[] objArr = this.elementData;
                ArraysKt.copyInto((T[]) objArr, (T[]) objArr, i + 1, i, positiveMod);
            } else {
                Object[] objArr2 = this.elementData;
    ...
    public <T> T[] toArray(T[] array) {
        ...
        int i = this.head;
        if (i < positiveMod) {
            ArraysKt.copyInto$default(this.elementData, (Object[]) arrayOfNulls, 0, i, positiveMod, 2, (Object) null);
        } else if (!isEmpty()) {
            Object[] objArr = this.elementData;
            ArraysKt.copyInto((T[]) objArr, arrayOfNulls, 0, this.head, objArr.length);
            Object[] objArr2 = this.elementData;
            ArraysKt.copyInto((T[]) objArr2, arrayOfNulls, objArr2.length - this.head, 0, positiveMod);
        }
