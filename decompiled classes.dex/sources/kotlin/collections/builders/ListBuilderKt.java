...
public final class ListBuilderKt {
    public static final /* synthetic */ String access$subarrayContentToString(Object[] $receiver, int offset, int length) {
        String subarrayContentToString = subarrayContentToString($receiver, offset, length);
        Log1F380D.a((Object) subarrayContentToString);
    ...
    public static final <T> int subarrayContentHashCode(T[] $this$subarrayContentHashCode, int offset, int length) {
        ...
        for (int i2 = 0; i2 < length; i2++) {
            T t = $this$subarrayContentHashCode[offset + i2];
            i = (i * 31) + (t != null ? t.hashCode() : 0);
        }
        return i;
    }
