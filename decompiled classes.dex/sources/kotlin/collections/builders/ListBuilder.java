...
public final class ListBuilder<E> extends AbstractMutableList<E> implements List<E>, RandomAccess, Serializable, KMutableList {
    ...
    private final int retainOrRemoveAllInternal(int rangeOffset, int rangeLength, Collection<? extends E> elements, boolean retain) {
        ...
        while (i < rangeLength) {
            if (elements.contains(this.array[rangeOffset + i]) == retain) {
                E[] eArr = this.array;
                eArr[i2 + rangeOffset] = eArr[i + rangeOffset];
                i2++;
                i++;
            } else {
                i++;
        ...
        int i3 = rangeLength - i2;
        E[] eArr2 = this.array;
        ArraysKt.copyInto((T[]) eArr2, (T[]) eArr2, rangeOffset + i2, rangeOffset + rangeLength, this.length);
        E[] eArr3 = this.array;
        int i4 = this.length;
        ListBuilderKt.resetRange(eArr3, i4 - i3, i4);
        this.length -= i3;
        return i3;
    }
    ...
    public String toString() {
        String access$subarrayContentToString = ListBuilderKt.access$subarrayContentToString(this.array, this.offset, this.length);
        Log1F380D.a((Object) access$subarrayContentToString);
        return access$subarrayContentToString;
    }
}
