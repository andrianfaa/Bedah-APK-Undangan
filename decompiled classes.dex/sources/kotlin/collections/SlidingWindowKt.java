...
public final class SlidingWindowKt {
    ...
    public static final <T> Iterator<List<T>> windowedIterator(Iterator<? extends T> iterator, int size, int step, boolean partialWindows, boolean reuseBuffer) {
        ...
        return !iterator.hasNext() ? EmptyIterator.INSTANCE : SequencesKt.iterator(new SlidingWindowKt$windowedIterator$1(size, step, iterator, reuseBuffer, partialWindows, (Continuation<? super SlidingWindowKt$windowedIterator$1>) null));
    }
