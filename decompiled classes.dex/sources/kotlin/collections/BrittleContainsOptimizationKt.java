...
public final class BrittleContainsOptimizationKt {
    ...
    public static final <T> Collection<T> convertToSetForSetOperation(T[] $this$convertToSetForSetOperation) {
        ...
        return CollectionSystemProperties.brittleContainsOptimizationEnabled ? ArraysKt.toHashSet($this$convertToSetForSetOperation) : ArraysKt.asList($this$convertToSetForSetOperation);
    }
