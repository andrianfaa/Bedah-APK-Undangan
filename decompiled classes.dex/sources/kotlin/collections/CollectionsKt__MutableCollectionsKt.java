...
class CollectionsKt__MutableCollectionsKt extends CollectionsKt__MutableCollectionsJVMKt {
    ...
    private static final <T> boolean filterInPlace$CollectionsKt__MutableCollectionsKt(Iterable<? extends T> $this$filterInPlace, Function1<? super T, Boolean> predicate, boolean predicateResultToRemove) {
        boolean z = false;
        Iterator<? extends T> it = $this$filterInPlace.iterator();
        while (it.hasNext()) {
            if (predicate.invoke(it.next()).booleanValue() == predicateResultToRemove) {
                it.remove();
                z = true;
            }
        }
    ...
    private static final <T> boolean filterInPlace$CollectionsKt__MutableCollectionsKt(List<T> $this$filterInPlace, Function1<? super T, Boolean> predicate, boolean predicateResultToRemove) {
        ...
        while (it.hasNext()) {
            ...
            T t = $this$filterInPlace.get(nextInt);
            if (predicate.invoke(t).booleanValue() != predicateResultToRemove) {
                if (i != nextInt) {
                    $this$filterInPlace.set(i, t);
                }
                i++;
            }
        }
        if (i >= $this$filterInPlace.size()) {
            return false;
        }
        ...
        while (true) {
            $this$filterInPlace.remove(lastIndex);
            if (lastIndex == i) {
                return true;
            }
            lastIndex--;
    ...
    public static final <T> boolean removeAll(Collection<? super T> $this$removeAll, Sequence<? extends T> elements) {
        Intrinsics.checkNotNullParameter($this$removeAll, "<this>");
        Intrinsics.checkNotNullParameter(elements, "elements");
        Collection<? extends T> convertToSetForSetOperation = BrittleContainsOptimizationKt.convertToSetForSetOperation(elements);
        return (convertToSetForSetOperation.isEmpty() ^ true) && $this$removeAll.removeAll(convertToSetForSetOperation);
    }
    ...
    public static final <T> boolean retainAll(Collection<? super T> $this$retainAll, Sequence<? extends T> elements) {
        ...
        Intrinsics.checkNotNullParameter(elements, "elements");
        Collection<? extends T> convertToSetForSetOperation = BrittleContainsOptimizationKt.convertToSetForSetOperation(elements);
        return convertToSetForSetOperation.isEmpty() ^ true ? $this$retainAll.retainAll(convertToSetForSetOperation) : retainNothing$CollectionsKt__MutableCollectionsKt($this$retainAll);
    }

    public static final <T> boolean retainAll(Collection<? super T> $this$retainAll, T[] elements) {
        Intrinsics.checkNotNullParameter($this$retainAll, "<this>");
        Intrinsics.checkNotNullParameter(elements, "elements");
        return (elements.length == 0) ^ true ? $this$retainAll.retainAll(BrittleContainsOptimizationKt.convertToSetForSetOperation(elements)) : retainNothing$CollectionsKt__MutableCollectionsKt($this$retainAll);
    }
    ...
    private static final boolean retainNothing$CollectionsKt__MutableCollectionsKt(Collection<?> $this$retainNothing) {
        boolean z = !$this$retainNothing.isEmpty();
