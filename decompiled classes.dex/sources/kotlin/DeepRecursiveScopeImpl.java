...
final class DeepRecursiveScopeImpl<T, R> extends DeepRecursiveScope<T, R> implements Continuation<R> {
    ...
    public <U, S> Object callRecursive(DeepRecursiveFunction<U, S> $this$callRecursive, U value2, Continuation<? super S> $completion) {
        Continuation<? super S> continuation = $completion;
        ...
        deepRecursiveScopeImpl.value = value2;
        Object coroutine_suspended = IntrinsicsKt.getCOROUTINE_SUSPENDED();
        if (coroutine_suspended == IntrinsicsKt.getCOROUTINE_SUSPENDED()) {
            DebugProbesKt.probeCoroutineSuspended($completion);
        }
    ...
    public final R runCallLoop() {
        while (true) {
            ...
            if (continuation == null) {
                ...
                return r;
            } else if (Result.m38equalsimpl0(DeepRecursiveKt.UNDEFINED_RESULT, r)) {
                try {
                    ...
                    if (invoke != IntrinsicsKt.getCOROUTINE_SUSPENDED()) {
                        ...
                        continuation.resumeWith(Result.m36constructorimpl(invoke));
                    }
                } catch (Throwable th) {
