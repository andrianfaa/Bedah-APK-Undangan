...
public class ULongProgression implements Iterable<ULong>, KMappedMarker {
    ...
    public static final class Companion {
        ...
        public final ULongProgression m1270fromClosedRange7ftBX0g(long rangeStart, long rangeEnd, long step) {
    ...
    private ULongProgression(long start, long endInclusive, long step2) {
        if (step2 == 0) {
            ...
            this.first = start;
            this.last = UProgressionUtilKt.m1246getProgressionLastElement7ftBX0g(start, endInclusive, step2);
            this.step = step2;
        } else {
    ...
    public int hashCode() {
        ...
        long j2 = this.last;
        long j3 = this.step;
        return (((((int) ULong.m208constructorimpl(j ^ ULong.m208constructorimpl(j >>> 32))) * 31) + ((int) ULong.m208constructorimpl(j2 ^ ULong.m208constructorimpl(j2 >>> 32)))) * 31) + ((int) ((j3 >>> 32) ^ j3));
    }
    ...
    public String toString() {
        ...
        if (this.step > 0) {
            ...
            String r2 = ULong.m253toStringimpl(this.first);
            Log1F380D.a((Object) r2);
            StringBuilder append = sb2.append(r2).append("..");
            String r22 = ULong.m253toStringimpl(this.last);
            Log1F380D.a((Object) r22);
            sb = append.append(r22).append(" step ");
            j = this.step;
        } else {
            StringBuilder sb3 = new StringBuilder();
            String r23 = ULong.m253toStringimpl(this.first);
            Log1F380D.a((Object) r23);
            StringBuilder append2 = sb3.append(r23).append(" downTo ");
            String r24 = ULong.m253toStringimpl(this.last);
            Log1F380D.a((Object) r24);
            sb = append2.append(r24).append(" step ");
            j = -this.step;
        }
