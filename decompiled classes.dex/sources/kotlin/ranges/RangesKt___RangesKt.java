...
class RangesKt___RangesKt extends RangesKt__RangesKt {
    ...
    public static final /* synthetic */ boolean byteRangeContains(ClosedRange $this$contains, double value) {
        ...
        if (byteExactOrNull != null) {
            return $this$contains.contains(byteExactOrNull);
        }
        return false;
    }
    ...
    public static final <T extends Comparable<? super T>> T coerceIn(T $this$coerceIn, T minimumValue, T maximumValue) {
        ...
        if (minimumValue == null || maximumValue == null) {
            return (minimumValue == null || $this$coerceIn.compareTo(minimumValue) >= 0) ? (maximumValue == null || $this$coerceIn.compareTo(maximumValue) <= 0) ? $this$coerceIn : maximumValue : minimumValue;
        }
    ...
    public static final <T extends Comparable<? super T>> T coerceIn(T $this$coerceIn, ClosedFloatingPointRange<T> range) {
        ...
        Intrinsics.checkNotNullParameter(range, "range");
        if (!range.isEmpty()) {
            return (!range.lessThanOrEquals($this$coerceIn, range.getStart()) || range.lessThanOrEquals(range.getStart(), $this$coerceIn)) ? (!range.lessThanOrEquals(range.getEndInclusive(), $this$coerceIn) || range.lessThanOrEquals($this$coerceIn, range.getEndInclusive())) ? $this$coerceIn : range.getEndInclusive() : range.getStart();
        }
        throw new IllegalArgumentException("Cannot coerce value to an empty range: " + range + '.');
    }
    ...
    public static final /* synthetic */ boolean intRangeContains(ClosedRange $this$contains, double value) {
        ...
        if (intExactOrNull != null) {
            return $this$contains.contains(intExactOrNull);
        }
        return false;
    }
    ...
    public static final /* synthetic */ boolean longRangeContains(ClosedRange $this$contains, double value) {
        ...
        if (longExactOrNull != null) {
            return $this$contains.contains(longExactOrNull);
        }
        return false;
    }
    ...
    public static final /* synthetic */ boolean shortRangeContains(ClosedRange $this$contains, double value) {
        ...
        if (shortExactOrNull != null) {
            return $this$contains.contains(shortExactOrNull);
        }
        return false;
    }
