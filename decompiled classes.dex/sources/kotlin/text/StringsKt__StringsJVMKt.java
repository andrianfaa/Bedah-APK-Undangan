...
class StringsKt__StringsJVMKt extends StringsKt__StringNumberConversionsKt {
    ...
    public static final String replace(String $this$replace, char oldChar, char newChar, boolean ignoreCase) {
        ...
        StringBuilder sb2 = sb;
        CharSequence charSequence = $this$replace;
        for (int i = 0; i < charSequence.length(); i++) {
            char charAt = charSequence.charAt(i);
            sb2.append(CharsKt.equals(charAt, oldChar, ignoreCase) ? newChar : charAt);
        }
        String sb3 = sb.toString();
    ...
    public static final String replace(String $this$replace, String oldValue, String newValue, boolean ignoreCase) {
        ...
        int indexOf = StringsKt.indexOf((CharSequence) str, oldValue, 0, ignoreCase);
        if (indexOf < 0) {
            return str;
        }
        ...
        if (length2 >= 0) {
            ...
            int i = 0;
            do {
                sb.append(str, i, indexOf).append(newValue);
                i = indexOf + length;
                if (indexOf >= str.length() || (indexOf = StringsKt.indexOf((CharSequence) str, oldValue, indexOf + coerceAtLeast, ignoreCase)) <= 0) {
                    String sb2 = sb.append(str, i, str.length()).toString();
                    Intrinsics.checkNotNullExpressionValue(sb2, "stringBuilder.append(this, i, length).toString()");
                }
                sb.append(str, i, indexOf).append(newValue);
                i = indexOf + length;
                break;
            } while ((indexOf = StringsKt.indexOf((CharSequence) str, oldValue, indexOf + coerceAtLeast, ignoreCase)) <= 0);
            String sb22 = sb.append(str, i, str.length()).toString();
    ...
    public static final String replaceFirst(String $this$replaceFirst, String oldValue, String newValue, boolean ignoreCase) {
        ...
        Intrinsics.checkNotNullParameter(oldValue, "oldValue");
        Intrinsics.checkNotNullParameter(newValue, "newValue");
        int indexOf$default = StringsKt.indexOf$default((CharSequence) $this$replaceFirst, oldValue, 0, ignoreCase, 2, (Object) null);
    ...
    private static final String String(byte[] bytes, int offset, int length, Charset charset) {
        Intrinsics.checkNotNullParameter(bytes, "bytes");
        Intrinsics.checkNotNullParameter(charset, "charset");
        String str = new String(bytes, offset, length, charset);
        Log1F380D.a((Object) str);
        return str;
    }
    ...
    private static final String String(int[] codePoints, int offset, int length) {
        ...
        String str = new String(codePoints, offset, length);
        Log1F380D.a((Object) str);
        return str;
    }
    ...
    public static final String capitalize(String $this$capitalize) {
        ...
        String capitalize = StringsKt.capitalize($this$capitalize, locale);
        Log1F380D.a((Object) capitalize);
        return capitalize;
    }
    ...
    public static final String concatToString(char[] $this$concatToString) {
        ...
        String str = new String($this$concatToString);
        Log1F380D.a((Object) str);
        return str;
    }
    ...
    public static final String concatToString(char[] $this$concatToString, int startIndex, int endIndex) {
        ...
        String str = new String($this$concatToString, startIndex, endIndex - startIndex);
        Log1F380D.a((Object) str);
        return str;
    }
    ...
    public static /* synthetic */ String concatToString$default(char[] cArr, int i, int i2, int i3, Object obj) {
        ...
        Log1F380D.a((Object) concatToString);
    ...
    public static final String decodeToString(byte[] $this$decodeToString) {
        ...
        String str = new String($this$decodeToString, Charsets.UTF_8);
        Log1F380D.a((Object) str);
        return str;
    }
    ...
    public static final String decodeToString(byte[] $this$decodeToString, int startIndex, int endIndex, boolean throwOnInvalidSequence) {
        ...
        if (!throwOnInvalidSequence) {
            String str = new String($this$decodeToString, startIndex, endIndex - startIndex, Charsets.UTF_8);
            Log1F380D.a((Object) str);
            return str;
        }
    ...
    public static /* synthetic */ String decodeToString$default(byte[] bArr, int i, int i2, boolean z, int i3, Object obj) {
        ...
        Log1F380D.a((Object) decodeToString);
    ...
    public static final String replaceFirst(String $this$replaceFirst, char oldChar, char newChar, boolean ignoreCase) {
        Intrinsics.checkNotNullParameter($this$replaceFirst, "<this>");
        int indexOf$default = StringsKt.indexOf$default((CharSequence) $this$replaceFirst, oldChar, 0, ignoreCase, 2, (Object) null);
        if (indexOf$default < 0) {
            return $this$replaceFirst;
        }
        String valueOf = String.valueOf(newChar);
        Log1F380D.a((Object) valueOf);
        return StringsKt.replaceRange((CharSequence) $this$replaceFirst, indexOf$default, indexOf$default + 1, (CharSequence) valueOf).toString();
    }
    ...
    public static /* synthetic */ String replaceFirst$default(String str, char c, char c2, boolean z, int i, Object obj) {
        ...
        Log1F380D.a((Object) replaceFirst);
        return replaceFirst;
    }
