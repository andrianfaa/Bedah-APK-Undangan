...
final class AdjustedTimeMark implements TimeMark {
    ...
    public long m1341elapsedNowUwyO8pc() {
        return Duration.m1384minusLRDsOJo(this.mark.m1484elapsedNowUwyO8pc(), this.adjustment);
    }

    /* renamed from: getAdjustment-UwyO8pc  reason: not valid java name */
    public final long m1342getAdjustmentUwyO8pc() {
    ...
    public TimeMark m1343minusLRDsOJo(long duration) {
        return TimeMark.DefaultImpls.m1487minusLRDsOJo(this, duration);
    }

    /* renamed from: plus-LRDsOJo  reason: not valid java name */
    public TimeMark m1344plusLRDsOJo(long duration) {
        return new AdjustedTimeMark(this.mark, Duration.m1385plusLRDsOJo(this.adjustment, duration), (DefaultConstructorMarker) null);
    }
}
