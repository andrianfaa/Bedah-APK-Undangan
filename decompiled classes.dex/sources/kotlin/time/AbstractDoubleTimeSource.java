...
public abstract class AbstractDoubleTimeSource implements TimeSource {
    ...
    private static final class DoubleTimeMark implements TimeMark {
        ...
        public TimeMark m1336minusLRDsOJo(long duration) {
            return TimeMark.DefaultImpls.m1487minusLRDsOJo(this, duration);
        }

        /* renamed from: plus-LRDsOJo  reason: not valid java name */
        public TimeMark m1337plusLRDsOJo(long duration) {
            return new DoubleTimeMark(this.startedAt, this.timeSource, Duration.m1385plusLRDsOJo(this.offset, duration), (DefaultConstructorMarker) null);
        }
    }
    ...
    public TimeMark markNow() {
        return new DoubleTimeMark(read(), this, Duration.Companion.m1451getZEROUwyO8pc(), (DefaultConstructorMarker) null);
    }
