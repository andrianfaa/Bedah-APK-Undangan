...
public final class MeasureTimeKt {
    public static final long measureTime(Function0<Unit> block) {
        ...
        long r3 = TimeSource.Monotonic.INSTANCE.m1489markNowz9LOYto();
        block.invoke();
        return TimeSource.Monotonic.ValueTimeMark.m1492elapsedNowUwyO8pc(r3);
    }
    ...
    public static final long measureTime(TimeSource.Monotonic $this$measureTime, Function0<Unit> block) {
        ...
        Intrinsics.checkNotNullParameter(block, "block");
        long r1 = $this$measureTime.m1489markNowz9LOYto();
        block.invoke();
        return TimeSource.Monotonic.ValueTimeMark.m1492elapsedNowUwyO8pc(r1);
    }

    public static final long measureTime(TimeSource $this$measureTime, Function0<Unit> block) {
        Intrinsics.checkNotNullParameter($this$measureTime, "<this>");
        Intrinsics.checkNotNullParameter(block, "block");
        TimeMark markNow = $this$measureTime.markNow();
        block.invoke();
        return markNow.m1484elapsedNowUwyO8pc();
    }

    public static final <T> TimedValue<T> measureTimedValue(Function0<? extends T> block) {
        Intrinsics.checkNotNullParameter(block, "block");
        return new TimedValue<>(block.invoke(), TimeSource.Monotonic.ValueTimeMark.m1492elapsedNowUwyO8pc(TimeSource.Monotonic.INSTANCE.m1489markNowz9LOYto()), (DefaultConstructorMarker) null);
    }
    ...
    public static final <T> TimedValue<T> measureTimedValue(TimeSource.Monotonic $this$measureTimedValue, Function0<? extends T> block) {
        ...
        Intrinsics.checkNotNullParameter(block, "block");
        return new TimedValue<>(block.invoke(), TimeSource.Monotonic.ValueTimeMark.m1492elapsedNowUwyO8pc($this$measureTimedValue.m1489markNowz9LOYto()), (DefaultConstructorMarker) null);
    }

    public static final <T> TimedValue<T> measureTimedValue(TimeSource $this$measureTimedValue, Function0<? extends T> block) {
        Intrinsics.checkNotNullParameter($this$measureTimedValue, "<this>");
        Intrinsics.checkNotNullParameter(block, "block");
        return new TimedValue<>(block.invoke(), $this$measureTimedValue.markNow().m1484elapsedNowUwyO8pc(), (DefaultConstructorMarker) null);
    }
}
