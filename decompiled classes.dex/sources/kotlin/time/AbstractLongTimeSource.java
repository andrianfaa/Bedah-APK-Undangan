...
public abstract class AbstractLongTimeSource implements TimeSource {
    ...
    private static final class LongTimeMark implements TimeMark {
        ...
        public long m1338elapsedNowUwyO8pc() {
            return Duration.m1384minusLRDsOJo(DurationKt.toDuration(this.timeSource.read() - this.startedAt, this.timeSource.getUnit()), this.offset);
        }
        ...
        public TimeMark m1339minusLRDsOJo(long duration) {
            return TimeMark.DefaultImpls.m1487minusLRDsOJo(this, duration);
        }

        /* renamed from: plus-LRDsOJo  reason: not valid java name */
        public TimeMark m1340plusLRDsOJo(long duration) {
            return new LongTimeMark(this.startedAt, this.timeSource, Duration.m1385plusLRDsOJo(this.offset, duration), (DefaultConstructorMarker) null);
        }
    }
    ...
    public TimeMark markNow() {
        return new LongTimeMark(read(), this, Duration.Companion.m1451getZEROUwyO8pc(), (DefaultConstructorMarker) null);
    }
