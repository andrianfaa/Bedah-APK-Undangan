...
public final class TimedValue<T> {
    ...
    public static /* synthetic */ TimedValue m1507copyRFiDyg4$default(TimedValue timedValue, T t, long j, int i, Object obj) {
        if ((i & 1) != 0) {
            t = timedValue.value;
        }
        if ((i & 2) != 0) {
        ...
        return timedValue.m1509copyRFiDyg4(t, j);
    }
    ...
    public final long m1508component2UwyO8pc() {
        return this.duration;
    }

    /* renamed from: copy-RFiDyg4  reason: not valid java name */
    public final TimedValue<T> m1509copyRFiDyg4(T t, long j) {
    ...
    public boolean equals(Object obj) {
        ...
        return Intrinsics.areEqual((Object) this.value, (Object) timedValue.value) && Duration.m1354equalsimpl0(this.duration, timedValue.duration);
    }

    /* renamed from: getDuration-UwyO8pc  reason: not valid java name */
    public final long m1510getDurationUwyO8pc() {
        return this.duration;
    }
    ...
    public int hashCode() {
        T t = this.value;
        return ((t == null ? 0 : t.hashCode()) * 31) + Duration.m1377hashCodeimpl(this.duration);
    }

    public String toString() {
        StringBuilder append = new StringBuilder().append("TimedValue(value=").append(this.value).append(", duration=");
        String r1 = Duration.m1398toStringimpl(this.duration);
        Log1F380D.a((Object) r1);
        return append.append(r1).append(')').toString();
    }
}
