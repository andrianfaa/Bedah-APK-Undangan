...
public interface TimeMark {
    ...
    public static final class DefaultImpls {
        public static boolean hasNotPassedNow(TimeMark $this) {
            return Duration.m1382isNegativeimpl($this.m1484elapsedNowUwyO8pc());
        }
        ...
        public static TimeMark m1487minusLRDsOJo(TimeMark $this, long duration) {
            return $this.m1486plusLRDsOJo(Duration.m1401unaryMinusUwyO8pc(duration));
        }

        /* renamed from: plus-LRDsOJo  reason: not valid java name */
        public static TimeMark m1488plusLRDsOJo(TimeMark $this, long duration) {
            return new AdjustedTimeMark($this, duration, (DefaultConstructorMarker) null);
        }
    }

    /* renamed from: elapsedNow-UwyO8pc  reason: not valid java name */
    long m1484elapsedNowUwyO8pc();
    ...
    /* renamed from: minus-LRDsOJo  reason: not valid java name */
    TimeMark m1485minusLRDsOJo(long j);

    /* renamed from: plus-LRDsOJo  reason: not valid java name */
    TimeMark m1486plusLRDsOJo(long j);
}
