...
class DurationUnitKt__DurationUnitJvmKt {
    ...
    public static final double convertDurationUnit(double value, DurationUnit sourceUnit, DurationUnit targetUnit) {
        ...
        long convert = targetUnit.getTimeUnit$kotlin_stdlib().convert(1, sourceUnit.getTimeUnit$kotlin_stdlib());
        return convert > 0 ? ((double) convert) * value : value / ((double) sourceUnit.getTimeUnit$kotlin_stdlib().convert(1, targetUnit.getTimeUnit$kotlin_stdlib()));
    }
