...
public final class KTypeProjection {
    ...
    public KTypeProjection(KVariance variance2, KType type2) {
        ...
        if (!((variance2 == null) != (type2 == null) ? false : true)) {
            throw new IllegalArgumentException((variance2 == null ? "Star projection must have no type specified." : "The projection variance " + variance2 + " requires type to be specified.").toString());
        }
    }
