...
class PathsKt__PathUtilsKt extends PathsKt__PathReadWriteKt {
    ...
    private static final Path copyTo(Path $this$copyTo, Path target, boolean overwrite) throws IOException {
        ...
        CopyOption[] copyOptionArr = overwrite ? new CopyOption[]{StandardCopyOption.REPLACE_EXISTING} : new CopyOption[0];
        Path copy = Files.copy($this$copyTo, target, (CopyOption[]) Arrays.copyOf(copyOptionArr, copyOptionArr.length));
    ...
    static /* synthetic */ Path copyTo$default(Path $this$copyTo_u24default, Path target, boolean overwrite, int i, Object obj) throws IOException {
        ...
        Intrinsics.checkNotNullParameter(target, TypedValues.AttributesType.S_TARGET);
        CopyOption[] copyOptionArr = overwrite ? new CopyOption[]{StandardCopyOption.REPLACE_EXISTING} : new CopyOption[0];
        Path copy = Files.copy($this$copyTo_u24default, target, (CopyOption[]) Arrays.copyOf(copyOptionArr, copyOptionArr.length));
        Intrinsics.checkNotNullExpressionValue(copy, "copy(this, target, *options)");
        return copy;
    }
    ...
    static /* synthetic */ void forEachDirectoryEntry$default(java.nio.file.Path r7, java.lang.String r8, kotlin.jvm.functions.Function1 r9, int r10, java.lang.Object r11) throws java.io.IOException {
        ...
        L_0x0006:
            ...
            r0 = 0
            r1 = r10
            java.nio.file.DirectoryStream r1 = (java.nio.file.DirectoryStream) r1     // Catch:{ all -> 0x0049 }
            r2 = 0
            java.lang.String r3 = "it"
            kotlin.jvm.internal.Intrinsics.checkNotNullExpressionValue(r1, r3)     // Catch:{ all -> 0x0049 }
            r3 = r1
            java.lang.Iterable r3 = (java.lang.Iterable) r3     // Catch:{ all -> 0x0049 }
            r4 = 0
            java.util.Iterator r5 = r3.iterator()     // Catch:{ all -> 0x0049 }
        L_0x002d:
            boolean r6 = r5.hasNext()     // Catch:{ all -> 0x0049 }
            if (r6 == 0) goto L_0x003b
            java.lang.Object r6 = r5.next()     // Catch:{ all -> 0x0049 }
            r9.invoke(r6)     // Catch:{ all -> 0x0049 }
            goto L_0x002d
        L_0x003b:
            kotlin.Unit r1 = kotlin.Unit.INSTANCE     // Catch:{ all -> 0x0049 }
    ...
    public static final String getExtension(Path $this$extension) {
        ...
        String substringAfterLast = StringsKt.substringAfterLast(fileName.toString(), '.', HttpUrl.FRAGMENT_ENCODE_SET);
    ...
    private static final Path moveTo(Path $this$moveTo, Path target, boolean overwrite) throws IOException {
        ...
        Intrinsics.checkNotNullParameter(target, TypedValues.AttributesType.S_TARGET);
        CopyOption[] copyOptionArr = overwrite ? new CopyOption[]{StandardCopyOption.REPLACE_EXISTING} : new CopyOption[0];
        Path move = Files.move($this$moveTo, target, (CopyOption[]) Arrays.copyOf(copyOptionArr, copyOptionArr.length));
    ...
    static /* synthetic */ Path moveTo$default(Path $this$moveTo_u24default, Path target, boolean overwrite, int i, Object obj) throws IOException {
        ...
        Intrinsics.checkNotNullParameter(target, TypedValues.AttributesType.S_TARGET);
        CopyOption[] copyOptionArr = overwrite ? new CopyOption[]{StandardCopyOption.REPLACE_EXISTING} : new CopyOption[0];
        Path move = Files.move($this$moveTo_u24default, target, (CopyOption[]) Arrays.copyOf(copyOptionArr, copyOptionArr.length));
        Intrinsics.checkNotNullExpressionValue(move, "move(this, target, *options)");
        return move;
    }
    ...
    static /* synthetic */ java.lang.Object useDirectoryEntries$default(java.nio.file.Path r4, java.lang.String r5, kotlin.jvm.functions.Function1 r6, int r7, java.lang.Object r8) throws java.io.IOException {
        ...
        L_0x0006:
            ...
            r0 = 0
            r1 = r7
            java.nio.file.DirectoryStream r1 = (java.nio.file.DirectoryStream) r1     // Catch:{ all -> 0x003a }
            r2 = 0
            java.lang.String r3 = "it"
            kotlin.jvm.internal.Intrinsics.checkNotNullExpressionValue(r1, r3)     // Catch:{ all -> 0x003a }
            r3 = r1
            java.lang.Iterable r3 = (java.lang.Iterable) r3     // Catch:{ all -> 0x003a }
            kotlin.sequences.Sequence r3 = kotlin.collections.CollectionsKt.asSequence(r3)     // Catch:{ all -> 0x003a }
            java.lang.Object r3 = r6.invoke(r3)     // Catch:{ all -> 0x003a }
    ...
    private static final String getInvariantSeparatorsPath(Path $this$invariantSeparatorsPath) {
        ...
        String invariantSeparatorsPathString = PathsKt.getInvariantSeparatorsPathString($this$invariantSeparatorsPath);
        Log1F380D.a((Object) invariantSeparatorsPathString);
    ...
    public static final String getInvariantSeparatorsPathString(Path $this$invariantSeparatorsPathString) {
        ...
        String replace$default = StringsKt.replace$default(obj, separator, "/", false, 4, (Object) null);
    ...
    public static final String getNameWithoutExtension(Path $this$nameWithoutExtension) {
        ...
        String substringBeforeLast$default = StringsKt.substringBeforeLast$default(fileName.toString(), ".", (String) null, 2, (Object) null);
