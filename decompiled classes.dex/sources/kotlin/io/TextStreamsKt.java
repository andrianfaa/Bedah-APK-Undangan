...
public final class TextStreamsKt {
    ...
    public static final long copyTo(Reader $this$copyTo, Writer out, int bufferSize) {
        ...
        int read = $this$copyTo.read(cArr);
        while (read >= 0) {
            out.write(cArr, 0, read);
            j += (long) read;
            read = $this$copyTo.read(cArr);
        }
        return j;
    }
    ...
    public static final List<String> readLines(Reader $this$readLines) {
        ...
        forEachLine($this$readLines, new TextStreamsKt$readLines$1(arrayList));
        return arrayList;
    }
    ...
    public static final String readText(Reader $this$readText) {
        ...
        copyTo$default($this$readText, stringWriter, 0, 2, (Object) null);
    ...
    private static final String readText(URL $this$readText, Charset charset) {
        ...
        String str = new String(readBytes($this$readText), charset);
    ...
    static /* synthetic */ String readText$default(URL $this$readText_u24default, Charset charset, int i, Object obj) {
        ...
        Intrinsics.checkNotNullParameter(charset, "charset");
        String str = new String(readBytes($this$readText_u24default), charset);
        Log1F380D.a((Object) str);
        return str;
    }
}
